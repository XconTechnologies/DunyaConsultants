...
- **June 24, 2025 - Statistics Text Size Reduction**: Reduced font sizes in hero section statistics - numbers from text-4xl/5xl/6xl to text-2xl/3xl/4xl, labels from text-base/lg/xl to text-sm/base, and adjusted spacing for more compact appearance.
