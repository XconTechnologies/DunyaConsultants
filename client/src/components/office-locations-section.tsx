  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-[#e8f0ff] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 left-0 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ backgroundColor: '#1E50CA' }}></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-1000" style={{ backgroundColor: '#1E50CA' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.h2
          ...
          style={{ fontSize: '32px', color: '#1E50CA' }}
          whileHover={{ 
            scale: 1.05,
            color: '#1E50CA',
              ...
              {offices.map((office, index) => (
                ...
                >
                  <Card className="h-full shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border-0 bg-white group hover:scale-105">
                    <div className="h-1.5" style={{ backgroundColor: office.gradient === "custom-blue" ? '#1E50CA' : '#1E50CA' }}></div>
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center space-x-1 mb-1">
                            ...
                            {office.isHeadOffice && (
                              <span className="text-white text-xs px-2 py-0.5 rounded-full font-semibold flex-shrink-0" style={{ backgroundColor: '#1E50CA' }}>
                                HQ
                              </span>
                            )}
                        ...
                        <div className="w-12 h-12 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300 flex-shrink-0 ml-2" style={{ backgroundColor: '#1E50CA' }}>
