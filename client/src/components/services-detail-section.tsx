                  ...
                  <div className="grid md:grid-cols-3 gap-8">
                    <Card className="text-center shadow-lg border-l-4 #1D50C9">
                      <CardContent className="p-6">
                        <Award className="h-12 w-12 #1845B3 mx-auto mb-3" />
                    ...
                    <Card className="text-center shadow-lg border-l-4 #1D50C9">
                      <CardContent className="p-6">
                        <Users className="h-12 w-12 #1845B3 mx-auto mb-3" />
                    ...
                    <Card className="text-center shadow-lg border-l-4 #1D50C9">
                      <CardContent className="p-6">
                        <Clock className="h-12 w-12 #1845B3 mx-auto mb-3" />
                      ...
                      <Card key={index} className="shadow-md hover:shadow-lg transition-shadow">
                        <CardContent className="p-4">
                          <div className="flex items-center space-x-3">
                            <CheckCircle className={`h-6 w-6 #1845B3 flex-shrink-0`} />
