                      ...
                      <div className="space-y-2">
                        {service.benefits.slice(0, 2).map((benefit, idx) => (
                          <div key={idx} className="flex items-center space-x-2">
                            <Star className="w-3 h-3 #1D50C9 fill-current" />
                      ...
                      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                        ...
                        {selectedService && (
                          <div className="grid md:grid-cols-2 gap-8 mt-8">
                            ...
                            <div>
                              <h3 className="text-xl font-semibold mb-6 flex items-center">
                                <CheckCircle className="w-6 h-6 mr-3 #1845B3" />
                                Key Benefits
                              </h3>
                              <div className="space-y-4">
                                {selectedService.benefits.map((benefit, idx) => (
                                  <div key={idx} className="flex items-start space-x-3">
                                    <CheckCircle className="w-5 h-5 #1845B3 mt-1" />
                              ...
                              <div className="grid md:grid-cols-2 gap-4">
                                {selectedService.includes.map((item, idx) => (
                                  <div key={idx} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                                    <CheckCircle className="w-5 h-5 #1845B3" />
