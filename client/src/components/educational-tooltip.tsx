...
const tooltipColors = {
  info: "from-[#1D50C9] to-blue-500",
  educational: "from-[#1D50C9] to-blue-500",
  achievement: "from-[#1D50C9] to-blue-500",
  process: "from-[#1D50C9] to-blue-500",
  location: "from-[#1D50C9] to-blue-500",
  statistic: "from-[#1D50C9] to-blue-500",
};
        ...
        <TooltipTrigger asChild>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-1 -right-1 w-4 h-4 #1D50C9 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100"
            >
