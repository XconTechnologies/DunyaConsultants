          ...
          {featuredEvent && (
            ...
            >
              <Link href={`/events/${featuredEvent.slug}`}>
                <Card className="overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer group border-0 relative bg-white flex flex-col h-[400px]" data-testid={`event-featured-${featuredEvent.id}`}>
