    ...
    <div className="flex gap-3 sm:gap-4 justify-center md:justify-start mt-4">
      {[
        ...
        <div key={item.label} className="flex flex-col items-center">
          <div className="bg-white text-blue-700 rounded-lg p-3 sm:p-4 min-w-[55px] sm:min-w-[65px] text-center shadow-md">
                ...
                <Card className="overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer group h-full border-0 relative" style={{ backgroundColor: '#476DC6' }} data-testid={`event-featured-${featuredEvent.id}`}>
                  ...
                  <div className="p-5 sm:p-7">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                      ...
                      <div className="space-y-4">
                        <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 group-hover:text-white transition-colors leading-tight" data-testid="text-event-title">
                          {featuredEvent.title}
                        </h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 p-5">
                      ...
                      <div className="flex-1 min-w-0 flex flex-col">
                        <div className="flex items-start justify-between gap-2 mb-3">
                          <h4 className="font-bold text-lg sm:text-xl text-gray-900 group-hover:text-white transition-colors line-clamp-2 leading-tight" data-testid="text-event-title">
                            {event.title}
                          </h4>
