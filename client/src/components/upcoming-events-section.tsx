    ...
    <div className="flex gap-3 sm:gap-4 justify-center md:justify-start mt-4">
      {[
        ...
        <div key={item.label} className="flex flex-col items-center">
          <div className="bg-white group-hover:bg-transparent rounded-lg p-3 sm:p-4 min-w-[55px] sm:min-w-[65px] text-center shadow-md group-hover:shadow-none transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-blue-700 group-hover:!text-transparent transition-colors">{item.value.toString().padStart(2, "0")}</div>
          </div>
