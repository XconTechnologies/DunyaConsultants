...
export default function TestimonialSection() {
  ...
  const renderStars = (rating: number) => {
    return Array.from({ length: 5 }, (_, index) => (
      <Star 
        key={index} 
        className={`w-6 h-6 ${index < rating ? '#3367D6 fill-green-600' : 'text-gray-300'}`} 
      />
    ));
  };
  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-br from-blue-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 right-0 w-64 h-64 #4285F4 rounded-full translate-x-32 -translate-y-32" />
        <div className="absolute bottom-0 left-0 w-96 h-96 #4285F4 rounded-full -translate-x-48 translate-y-48" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-32 h-1 #3367D6 rounded-full opacity-70" />
          </motion.h2>
        </motion.div>
        ...
        >
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl p-8 lg:p-12 border border-gray-100">
            ...
            <div className="absolute -top-3 left-8">
              <div className="w-8 h-16 #4285F4 rounded-full transform rotate-12 shadow-md" 
                   style={{
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className={`bg-white rounded-lg p-4 shadow-md border-2 ${
                index === currentIndex ? '#4285F4' : 'border-transparent'
              }`}>
