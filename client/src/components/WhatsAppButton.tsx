          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
            ...
            <div className="mb-4">
              <textarea
                ...
                className="w-full p-3 border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:border-transparent"
                rows={4}
                autoFocus
              />
            </div>
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-lg flex items-center space-x-2 transition-colors"
              >
