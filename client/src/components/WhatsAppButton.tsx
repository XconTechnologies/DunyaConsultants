...
export default function WhatsAppButton() {
  ...
  const handleSendMessage = () => {
    ...
    const finalMessage = message.trim() || "Hi! I'm interested in studying abroad and would like to know more about your services.";
          ...
          <div className="p-5 bg-gray-50">
            ...
            <div className="mb-4">
              <textarea
                ...
                className="w-full p-4 border-2 border-gray-200 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-[#1D50C9] focus:border-transparent text-sm text-gray-800 bg-white shadow-sm"
                rows={3}
                autoFocus
              />
            </div>
            ...
            {/* Contact Person */}
            <div className="bg-white rounded-xl p-4 border border-gray-100 hover:shadow-md cursor-pointer transition-all duration-200 mb-4" onClick={handleSendMessage}>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 rounded-full bg-[#1D50C9] flex items-center justify-center shadow-lg">
                    <div className="text-white font-bold text-lg">DW</div>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 text-base">Dr. Waleed Mostafa</h4>
                    <p className="text-sm text-gray-600">Branch Manager - Egypt</p>
                  </div>
                </div>
