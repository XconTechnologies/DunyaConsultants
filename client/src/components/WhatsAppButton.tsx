          ...
          <div className="bg-[#1D50C9] text-white p-4 rounded-t-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-white !text-white" style={{ color: '#ffffff' }}>Start a Conversation</h3>
                  <p className="text-xs text-white !text-white" style={{ color: '#ffffff' }}>Hi! Click one of our member below to chat on WhatsApp</p>
                </div>
              </div>
              <button
          ...
          <div className="p-4">
            ...
            <div className="mb-4">
              <textarea
                ...
                className="w-full p-3 border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-[#1D50C9] focus:border-transparent text-sm text-gray-900"
                rows={3}
                autoFocus
              />
            </div>
