  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-4xl lg:text-5xl font-bold mb-4" style={{ color: '#1D50C9' }}>
            Study Abroad{" "}
              ...
              <CardContent className="space-y-8">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-2xl font-bold #1845B3">{result.score}/100</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div
                      className={`h-3 rounded-full ${
                        result.score >= 80 ? "#1D50C9" :
                        result.score >= 60 ? "#1D50C9" : "#1D50C9"
                      }`}
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                    <Award className="w-5 h-5 #1845B3" />
                    Recommendations
                  </h3>
                  <div className="space-y-3">
                    {result.recommendations.map((recommendation, index) => (
                      <div key={index} className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 #1D50C9 mt-0.5 flex-shrink-0" />
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                    <MapPin className="w-5 h-5 #1845B3" />
                    Next Steps
                  </h3>
                  <div className="space-y-3">
                ...
                <div className="flex gap-4 pt-6">
                  ...
                  <Button
                    className="flex-1 bg-gradient-to-r from-[#1D50C9] to-[#1845B3] hover:from-#1a73e8 hover:to-[#1a73e8]"
                  >
                  ...
                  {steps.map((step, index) => (
                    <div key={index} className="flex items-center gap-2">
                      ...
                      <span className={`text-sm font-medium ${
                        index <= currentStep ? "#1845B3" : "text-gray-500"
                      }`}>
                        {step.title}
                      </span>
                      {index < steps.length - 1 && (
                        <div className={`w-8 h-0.5 mx-4 ${
                          index < currentStep ? "#1845B3" : "bg-gray-200"
                        }`} />
                      )}
                    </div>
                  ))}
                  ...
                  <div className="flex justify-between pt-6">
                    ...
                    {currentStep < 2 ? (
                      ...
                      <Button
                        ...
                        className="bg-gradient-to-r from-[#1D50C9] to-[#1845B3] hover:from-#1a73e8 hover:to-[#1a73e8]"
                      >
