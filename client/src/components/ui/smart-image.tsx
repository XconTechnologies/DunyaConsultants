...
interface SmartImageProps extends Omit<ImgHTMLAttributes<HTMLImageElement>, 'alt' | 'sizes'> {
  ...
  priority?: boolean; // Custom prop for eager loading with high fetchpriority (not passed to img tag)
  loadingStrategy?: 'eager' | 'lazy'; // Loading strategy when priority is false
...
export function SmartImage({ 
  ...
  // Compute loading mode: priority overrides loadingStrategy
  const loadingMode = priority ? 'eager' : loadingStrategy;
