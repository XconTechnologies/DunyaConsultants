      ...
      <div className="bg-gradient-to-r from-[#1D50C9] to-[#1845B3] rounded-2xl shadow-2xl p-6 sm:p-10 border border-blue-600/20" style={{ color: 'white' }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            ...
            className="inline-flex items-center justify-center px-8 py-4 bg-white text-[#1D50C9] hover:bg-blue-50 font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 w-full sm:w-auto"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center px-8 py-4 bg-white/10 text-white hover:bg-white/20 font-semibold rounded-xl border-2 border-white/30 backdrop-blur-sm transition-all duration-300 hover:scale-105 w-full sm:w-auto"
          >
    ...
    <div className="my-8 w-full max-w-4xl mx-auto" data-block-type="whatsappChannel">
      <div className="bg-gradient-to-r from-[#1D50C9] to-[#1845B3] rounded-2xl shadow-xl p-6 sm:p-8 border border-blue-600/20" style={{ color: 'white' }}>
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
          ...
          >
            <button className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 bg-white text-[#1D50C9] hover:bg-blue-50 hover:scale-105 font-semibold shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
