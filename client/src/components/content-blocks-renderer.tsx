        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          {button2Text && (
            <a
              ...
              className="bg-white/20 border-2 border-white hover:bg-white hover:text-[#1D50C9] px-8 py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 inline-flex items-center justify-center"
              style={{ 
                ...whiteTextStyle,
                fontFamily: 'Inter, Lato, sans-serif'
              }}
