    ...
    return (
      <Dialog>
        ...
        <DialogContent className="max-w-md bg-white">
          <DialogHeader>
            <DialogTitle className="text-center #1845B3">Application Submitted Successfully!</DialogTitle>
          </DialogHeader>
          <div className="text-center space-y-4">
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <p className="#1845B3">(+92) 304 1110947</p>
            </div>
          </div>
        </DialogContent>
      </Dialog>
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-lg bg-white max-h-[80vh] overflow-y-auto" aria-describedby="application-form-description">
        <DialogHeader>
          <DialogTitle className="text-xl text-[#1D50C9] flex items-center justify-between">
            Apply to {country}
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button 
            type="submit" 
            className="w-full bg-[#1D50C9] hover:bg-[#0d3fb8] text-white py-3"
