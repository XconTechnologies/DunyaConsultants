  ...
  return (
    <section className="py-10 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-#1e3a8a to-#1565c0">
        <div className="absolute inset-0 opacity-20">
          <div className="w-full h-full relative">
            {/* Floating circles */}
            <motion.div 
              className="absolute w-72 h-72 #1D50C9 rounded-full blur-3xl opacity-30"
              animate={{ 
                x: [0, 100, 0], 
                y: [0, -50, 0],
                scale: [1, 1.2, 1]
            ...
            />
            <motion.div 
              className="absolute w-96 h-96 #1D50C9 rounded-full blur-3xl opacity-20"
              animate={{ 
                x: [0, -80, 0], 
                y: [0, 60, 0],
                scale: [1, 0.8, 1]
            ...
            />
            <motion.div 
              className="absolute w-80 h-80 #1D50C9 rounded-full blur-3xl opacity-25"
              animate={{ 
                x: [0, 60, 0], 
                y: [0, -80, 0],
                scale: [1, 1.1, 1]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-5xl font-bold mb-6" style={{ color: '#1D50C9' }}>
            Let's Connect
          </h2>
        ...
        >
          ...
          <div className="relative flex justify-center">
            <div className="relative w-96 h-96">
              ...
              >
                <div className="w-24 h-24 bg-gradient-to-br from-blue-400 to-[#1845B3] rounded-full flex flex-col items-center justify-center text-white shadow-xl cursor-pointer group relative">
