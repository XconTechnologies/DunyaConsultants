...
export default function ContactForm({ className = "" }: ContactFormProps) {
  ...
  return (
    <div className={`bg-gradient-to-r from-[#1D50C9] to-#1565c0 rounded-xl p-6 text-white shadow-xl border #1845B3/20 ${className}`}>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="text-center pt-2">
          <Button
            ...
            className="bg-gradient-to-r from-[#1D50C9] to-[#1845B3] hover:from-[#1D50C9] hover:to-[#1a73e8] text-white px-8 py-3 rounded-full font-medium shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 text-sm border-0 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
      ...
      <div className="mt-6 pt-5 border-t border-white/20">
        <div className="grid grid-cols-1 gap-3">
          <div className="flex items-center space-x-3 p-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
            <div className="w-8 h-8 #1845B3 rounded-full flex items-center justify-center">
