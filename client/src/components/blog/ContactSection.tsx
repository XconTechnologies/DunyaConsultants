...
export default function ContactSection() {
  return (
    <div className="bg-gradient-to-r from-[#1D50C9] to-#1565c0 rounded-xl p-8 text-white shadow-xl border #1845B3/20 max-w-md mx-auto">
      <div className="space-y-6">
        <div className="flex items-center space-x-4 p-4 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
          <div className="w-12 h-12 #1845B3 rounded-full flex items-center justify-center">
