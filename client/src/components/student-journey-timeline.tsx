  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.h2 
            className="text-4xl md:text-5xl font-bold mb-6" style={{ color: '#1D50C9' }}
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center mb-5 relative z-10">
                    <motion.div
                      className="w-12 h-12 bg-gradient-to-br from-[#1D50C9] to-[#1845B3] rounded-full flex items-center justify-center text-white shadow-lg mr-4"
                    ...
                    <div className="flex flex-col">
                      <motion.span
                        className="text-xs #1845B3 font-bold uppercase tracking-wider"
                        initial={{ opacity: 0 }}
                  ...
                  >
                    <div className="text-xs font-medium #1845B3 mb-3 uppercase tracking-wide flex items-center">
                      <motion.div
                        className="w-2 h-2 #1D50C9 rounded-full mr-2"
                  ...
                  <motion.div
                    className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-[#1D50C9] to-[#1845B3] opacity-0 group-hover:opacity-100 transition-opacity duration-300"
        ...
        >
          <motion.button
            className="inline-flex items-center gap-3 bg-gradient-to-r from-[#1D50C9] to-[#1845B3] text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
          ...
          <p className="text-gray-600 mt-4 text-sm">
            Total Journey Duration: <span className="font-semibold #1845B3">6-12 months</span>
          </p>
        </motion.div>
      </div>
    </section>
