...
import { CheckCircle, DollarSign, FileText, GraduationCap, Globe, MapPin, Calendar, Calculator, FileCheck, Users, Zap, Snowflake } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section 
        ...
        style={{
          backgroundImage: 'linear-gradient(135deg, #003580 0%, #ffffff 50%, #003580 100%)',
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="bg-blue-50 border-blue-200">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-3xl font-bold text-blue-600">€8,000 - €12,000</p>
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4">
                  <Button 
                    ...
                    onClick={() => window.open('/cost-calculator?country=finland', '_blank')}
                  >
                    <Calculator className="w-8 h-8 text-blue-600" />
                    <span className="font-semibold">Cost Calculator</span>
                    <span className="text-sm text-gray-600 text-center">Calculate your total study costs in Finland</span>
                  </Button>
                  
                  <Button 
                    variant="outline" 
                    className="h-auto p-6 flex flex-col items-center space-y-2 hover:bg-green-50"
                    onClick={() => window.open('/course-match-tool?country=finland', '_blank')}
                  >
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('/document-checklist?country=finland', '_blank')}
                  >
