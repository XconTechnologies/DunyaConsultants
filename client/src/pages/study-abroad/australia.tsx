              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4">
                  <Button 
                    ...
                    onClick={() => window.open('/cost-calculator?country=au', '_blank')}
                  >
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('/course-match-tool?country=au', '_blank')}
                  >
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('/document-checklist?country=au', '_blank')}
                  >
