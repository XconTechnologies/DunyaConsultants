...
import { CheckCircle, DollarSign, FileText, GraduationCap, Globe, MapPin, Calendar, Calculator, FileCheck, Users, Zap, Sun } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section 
        ...
        style={{
          backgroundImage: 'linear-gradient(135deg, #006A4E 0%, #FFD700 50%, #006A4E 100%)',
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold text-white">
                Study in <span className="text-yellow-400">Australia</span>
              </h1>
            </div>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          <div className="flex justify-between items-center p-3 bg-green-50 rounded">
                            ...
                            <span className="text-green-600 font-semibold">{req.ug}</span>
                          </div>
                          <div className="flex justify-between items-center p-3 bg-yellow-50 rounded">
                            <span className="font-medium">Postgraduate:</span>
                            <span className="text-yellow-600 font-semibold">{req.pg}</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="bg-green-50 border-green-200">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-3xl font-bold text-green-600">AUD $20,000 - $35,000</p>
                      <p className="text-green-700">per year</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-yellow-50 border-yellow-200">
                    <CardContent className="p-6 text-center">
                      <h4 className="font-semibold text-yellow-900 mb-2">Postgraduate Programs</h4>
                      <p className="text-3xl font-bold text-yellow-600">AUD $22,000 - $45,000</p>
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <p className="text-green-700 text-sm">Students can work up to 48 hours per fortnight during study and unlimited hours during breaks. Post-study work visas available for 2-4 years.</p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4">
                  <Button 
                    ...
                    onClick={() => window.open('/cost-calculator?country=australia', '_blank')}
                  >
                    <Calculator className="w-8 h-8 text-green-600" />
                    <span className="font-semibold">Cost Calculator</span>
                    <span className="text-sm text-gray-600 text-center">Calculate your total study costs in Australia</span>
                  </Button>
                  
                  <Button 
                    variant="outline" 
                    className="h-auto p-6 flex flex-col items-center space-y-2 hover:bg-yellow-50"
                    onClick={() => window.open('/course-match-tool?country=australia', '_blank')}
                  >
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('/document-checklist?country=australia', '_blank')}
                  >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <p className="font-semibold text-green-900">UAN Number</p>
                  <p className="text-xl font-bold text-green-600">(+92) 304 1110947</p>
                </div>
