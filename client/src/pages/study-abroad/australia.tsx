...
export default function StudyAbroadAustralia() {
  ...
  const whyStudyAustralia = [
    { icon: Building, title: "Top-Quality Education", desc: "Home to world's best universities including University of Melbourne, ANU, and University of Sydney" },
    { icon: FileText, title: "No IELTS Required", desc: "Many universities accept TOEFL, PTE, Duolingo, or waive requirements for English-medium education" },
    { icon: Briefcase, title: "Post-Study Work Visa", desc: "Gain valuable work experience with post-study work visa up to 4 years" },
    { icon: DollarSign, title: "Affordable Tuition", desc: "Competitive costs compared to US or UK with excellent value for education" },
    { icon: Globe, title: "Multicultural Environment", desc: "Diverse and inclusive environment with students from all over the world" },
    { icon: Home, title: "Path to PR", desc: "Pathway to permanent residency through Skilled Migration Program" }
  ];
  ...
  const popularCourses = [
    { name: "Information Technology", demand: "Very High" },
    { name: "Business & Management", demand: "Very High" },
    { name: "Engineering", demand: "High" },
    { name: "Health Sciences", demand: "Very High" },
    { name: "Accounting & Finance", demand: "High" },
    { name: "Data Science", demand: "Very High" },
    { name: "Hospitality & Tourism", demand: "High" },
    { name: "Environmental Science", demand: "High" },
    { name: "Media & Communications", demand: "High" }
  ];

  const faqs = [
    {
      question: "How Much Does It Cost to Study in Australia from Pakistan?",
      answer: "The cost of studying in Australia ranges from AUD 20,000 to AUD 50,000 per year for tuition fees, with living expenses of AUD 1,000 to AUD 2,500 per month."
    },
    {
      question: "How Do I Apply for a Study Visa in Australia?",
      answer: "To apply for a study visa, you need an offer from an Australian university. You'll then submit your visa application to the Department of Home Affairs along with required documents."
    },
    {
      question: "Can I Study in Australia Without IELTS?",
      answer: "Yes, many universities in Australia accept alternative English proficiency tests or waive IELTS for students with previous education in English."
    },
    {
      question: "What Are the Requirements for a Study Visa in Australia?",
      answer: "To apply for a student visa, you need an acceptance letter from an Australian university, proof of financial support, a passport, and proof of English proficiency (if required)."
    },
    {
      question: "How Can I Get Permanent Residency in Australia After Study?",
      answer: "After completing your studies, you can apply for a post-study work visa, which may lead to permanent residency through Australia's immigration programs, such as the Skilled Migration Program."
    }
  ];
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 bg-white/10 backdrop-blur-xl rounded-3xl mb-6 border border-white/20 shadow-2xl relative group">
              ...
              <Sun className="w-10 h-10 sm:w-12 sm:h-12 relative z-10" />
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Study in <span className="bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-white animate-pulse">Australia</span>
            </h1>
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white/70 backdrop-blur-sm" data-testid="introduction-card">
              <CardContent className="p-6 sm:p-8">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">Why Study in Australia?</h2>
                    <p className="text-gray-600">Your Gateway to World-Class Education and Career Growth</p>
                  </div>
                </div>
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Australia is one of the most popular destinations for international students, offering world-class education, a multicultural environment, and excellent post-graduation opportunities. For Pakistani students, studying in Australia offers not only high-quality academic experiences but also the chance to build a successful career.
                  </p>
                  <p>
            ...
            {/* Why Study in Australia - Modern Icon Grid */}
            <Card className="border-0 shadow-lg overflow-hidden bg-gradient-to-br from-white via-blue-50/30 to-white" data-testid="why-study-australia-card">
              ...
              <CardContent className="p-6 sm:p-8">
                <p className="text-gray-700 mb-8 leading-relaxed text-lg">
                  Australia offers world-recognized degrees, excellent job opportunities, innovative research, and numerous scholarships for international students.
                </p>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 via-white to-orange-50/30" data-testid="study-without-ielts-card">
              ...
              <CardContent className="p-6 sm:p-8">
                <p className="text-gray-700 mb-6 leading-relaxed">
                  Many universities in Australia accept alternative methods of demonstrating English proficiency, allowing students to study in Australia without IELTS:
                </p>
                ...
                <div className="bg-gradient-to-r from-orange-100 to-red-100/50 p-5 rounded-2xl shadow-sm">
                  <p className="text-gray-700 font-medium">
                    <strong className="text-gray-900">Previous English Education Accepted</strong><br />
            ...
            <Card className="border-0 shadow-lg overflow-hidden bg-white" data-testid="cost-requirements-card">
              <div className="bg-gradient-to-r from-[#1D50C9] to-[#1845B3] p-6 text-white">
                ...
                <p className="text-white/90 mt-2">Understand the investment needed for your Australian education</p>
              </div>
              <CardContent className="p-6 sm:p-8">
                <p className="text-gray-700 mb-6 leading-relaxed">
                  The cost of studying in Australia can vary based on the level of study, the university, and the program you choose. Here's a breakdown of typical costs:
                </p>
                <div className="space-y-4">
                  {[
                    { icon: GraduationCap, title: "Bachelor's Programs", desc: "AUD 20,000–AUD 45,000 per year", color: "from-[#1D50C9] to-[#1845B3]" },
                    { icon: Award, title: "Master's Programs", desc: "AUD 22,000–AUD 50,000 per year", color: "from-[#1D50C9] to-[#1845B3]" },
                    { icon: BookOpen, title: "Doctoral Programs", desc: "AUD 18,000–AUD 42,000 per year", color: "from-[#1D50C9] to-[#1845B3]" },
                    { icon: Building, title: "Living Expenses", desc: "AUD 1,000–AUD 2,500 per month (depending on city)", color: "from-[#1D50C9] to-[#1845B3]" }
                  ].map((item, index) => (
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 via-white to-blue-50/30" data-testid="visa-application-card">
              ...
              <CardContent className="p-6 sm:p-8">
                <p className="text-gray-700 mb-6 leading-relaxed">
                  To study in Australia, you'll need to apply for a student visa (subclass 500). Here's how to get started:
                </p>
                <div className="space-y-4">
                  {[
                    { step: "1", title: "Get Accepted into a University", desc: "You must first receive an offer from a recognized Australian institution" },
                    { step: "2", title: "Prepare Your Documents", desc: "Offer letter, proof of funds for tuition and living expenses, passport, English proficiency, and health insurance" },
                    { step: "3", title: "Apply for Student Visa", desc: "Submit your visa application through the Australian Department of Home Affairs website" },
                    { step: "4", title: "Visa Interview (If Required)", desc: "Be prepared to demonstrate your financial stability and genuine intent to study in Australia" }
                  ].map((item, index) => (
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 via-white to-orange-50/30" data-testid="study-gap-card">
              <CardHeader>
                <CardTitle className="text-2xl text-gray-900 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
              ...
              <CardContent className="p-6 sm:p-8">
                <p className="text-gray-700 mb-6 leading-relaxed">
                  Australian universities tend to be flexible regarding study gaps, especially if you have relevant work experience or other accomplishments:
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="group p-5 bg-white rounded-2xl shadow-[0_2px_8px_rgba(249,115,22,0.2)] hover:shadow-[0_6px_16px_rgba(249,115,22,0.4)] transition-all duration-300">
                    <Badge className="bg-[#1D50C9] text-white text-xs px-2 py-1 mb-3">Bachelor's Programs</Badge>
                    <p className="text-gray-700">Gaps of up to <span className="font-bold text-[#1D50C9]">2-3 years</span> are generally accepted</p>
                  </div>
                  <div className="group p-5 bg-white rounded-2xl shadow-[0_2px_8px_rgba(249,115,22,0.2)] hover:shadow-[0_6px_16px_rgba(249,115,22,0.4)] transition-all duration-300">
                    <Badge className="bg-[#1D50C9] text-white text-xs px-2 py-1 mb-3">Master's Programs</Badge>
                    <p className="text-gray-700">Gap of <span className="font-bold text-[#1D50C9]">5-10 years</span> may be accepted with strong justification</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg overflow-hidden bg-white" data-testid="post-study-work-card">
              ...
              <CardContent className="p-6 sm:p-8">
                <p className="text-gray-700 mb-6 leading-relaxed">
                  After completing your studies, you can apply for a post-study work visa, allowing you to gain valuable work experience in Australia's thriving job market:
                </p>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="group p-6 bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl shadow-[0_2px_8px_rgba(29,80,201,0.15)] hover:shadow-[0_6px_16px_rgba(29,80,201,0.3)] transition-all duration-300">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <Badge className="bg-[#1D50C9] text-white text-xs px-2 py-1">Work Visa</Badge>
                    </div>
                    <p className="text-gray-700">Post-study work visa allows you to work <span className="font-bold text-[#1D50C9]">up to 4 years</span> after graduation</p>
                  </div>
                  <div className="group p-6 bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl shadow-[0_2px_8px_rgba(29,80,201,0.15)] hover:shadow-[0_6px_16px_rgba(29,80,201,0.3)] transition-all duration-300">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#1D50C9] to-[#1845B3] flex items-center justify-center">
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 via-white to-gray-50/30" data-testid="universities-card">
              ...
              <CardContent className="p-6 sm:p-8">
                <p className="text-gray-700 mb-6 leading-relaxed">
                  Australia is home to some of the world's leading universities, including the University of Melbourne, Australian National University (ANU), and the University of Sydney:
                </p>
                <div className="grid sm:grid-cols-2 gap-3">
              ...
              <CardHeader className="relative">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Expert Guidance for Your Australian Dream</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="relative p-6 sm:p-8">
                <p className="text-white/95 mb-8 leading-relaxed text-base md:text-lg">
                  Studying in Australia provides Pakistani students with the opportunity to receive a world-class education while exploring a multicultural environment. With affordable tuition, various scholarship opportunities, and the chance to gain work experience after graduation, Australia is a great choice for higher education. Our expert team provides comprehensive support:
                </p>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="border-0 shadow-xl bg-gradient-to-br from-[#1D50C9] to-[#1845B3] text-white sticky top-24" data-testid="quick-contact-card">
              ...
              <CardContent>
                <p className="text-white/90 mb-6 leading-relaxed">
                  Ready to start your Australia study journey? Our expert consultants are here to help you every step of the way.
                </p>
            ...
            <Card className="border-0 shadow-lg bg-white sticky top-[430px]" data-testid="quick-facts-card">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  {[
                    { label: "Visa Type", value: "Subclass 500" },
                    { label: "English Test", value: "Optional (MOI)" },
                    { label: "Tuition Range", value: "AUD 20K - 50K/year" },
