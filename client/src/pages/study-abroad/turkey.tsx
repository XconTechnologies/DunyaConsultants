...
import { CheckCircle, DollarSign, FileText, GraduationCap, Globe, MapPin, Calendar, Calculator, FileCheck, Users, Zap, Building2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section 
        ...
        style={{
          backgroundImage: 'linear-gradient(135deg, #e30a17 0%, #ffffff 50%, #e30a17 100%)',
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4">
                  <Button 
                    ...
                    onClick={() => window.open('/cost-calculator?country=turkey', '_blank')}
                  >
                    <Calculator className="w-8 h-8 text-red-600" />
                    <span className="font-semibold">Cost Calculator</span>
                    <span className="text-sm text-gray-600 text-center">Calculate your total study costs in Turkey</span>
                  </Button>
                  
                  <Button 
                    variant="outline" 
                    className="h-auto p-6 flex flex-col items-center space-y-2 hover:bg-gray-50"
                    onClick={() => window.open('/course-match-tool?country=turkey', '_blank')}
                  >
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('/document-checklist?country=turkey', '_blank')}
                  >
