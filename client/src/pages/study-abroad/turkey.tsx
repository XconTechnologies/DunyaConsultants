              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4">
                  <Button 
                    ...
                    onClick={() => window.open('/cost-calculator?country=tr', '_blank')}
                  >
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('/course-match-tool?country=tr', '_blank')}
                  >
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('/document-checklist?country=tr', '_blank')}
                  >
