              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4">
                  <Button 
                    ...
                    onClick={() => window.open('/cost-calculator?country=canada', '_blank')}
                  >
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('/course-match-tool?country=canada', '_blank')}
                  >
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('/document-checklist?country=canada', '_blank')}
                  >
