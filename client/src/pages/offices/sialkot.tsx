...
export default function SialkotOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Sialkot Office",
      "Expert study abroad consultants in Sialkot helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
