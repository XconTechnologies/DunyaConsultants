...
export default function SialkotOffice() {
  ...
  const services = [
    {
      ...
      description: "Find the perfect program and country that fits your goals and budget. Our advisors at Sialkot sit down with you, understand your profile, and suggest the best study options for your future.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: GraduationCap,
      title: "University Selection",
      description: "Shortlists that fit your profile and deadlines for applications. We will assist you in selecting a study abroad program that suits your profile and budget.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: FileText,
      title: "Application Handling",
      description: "Making sure documents, forms, and SOPs are ready on time and in the right way. We prepare your documents, fill out forms, and make sure everything is submitted on time.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Globe,
      title: "Visa Guidance",
      description: "Current checklists, file reviews, and interview prep. Our study visa experts at Sialkot follow the process with greatest care and meet the most recent rules.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: MessageCircle,
    ...
    },
    {
      ...
      description: "Before you leave, get information about your trip, where you'll stay, the culture, and how to pack. We'll give you advice ensuring a smooth start to your new adventure.",
      color: "from-blue-500 to-blue-600"
    }
  ];
  ...
  const ieltsFeatures = [
    ...
    "Modern teaching with practical tasks – Easy lessons that actually make sense and simple explanations",
    "Small batches for personal feedback – More personal attention and feedback",
    "Free assessment to plan your band-score improvement – Find out where you stand and how to improve",
    "End-to-end support: IELTS + admission + visa under one roof – A supportive environment with the latest facilities"
  ];

  const whyChooseUs = [
    "Local office in Sialkot for easy access",
  ...
  const faqs = [
    {
      question: "Which countries can I apply to from Sialkot?",
      answer: "We handle applications for the USA, UK, Australia, Canada, Belgium, Cyprus, Germany, Turkey, Finland, and Ireland; matched to your budget, profile, and intake."
    },
    {
    ...
    },
    {
      ...
      answer: "Often yes. As study visa consultants in Sialkot, we align the course level and country, then strengthen your case with a focused SOP and supporting evidence."
    },
    {
      question: "Do you offer IELTS classes in Sialkot?",
    ...
    },
    {
      ...
      answer: "Begin 6–9 months before your target intake to secure offers, scholarships, and a smooth visa timeline."
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center px-6 py-3 bg-white/15 rounded-full backdrop-blur-sm mb-8 border border-white/20">
              ...
              <span className="text-sm font-medium">Sialkot Office</span>
            </div>
            
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8 text-white">
              Study Abroad Consultants in Sialkot | Student Visa & IELTS Guidance
            </h1>
            
            <p className="text-xl lg:text-2xl mb-10 text-white leading-relaxed max-w-4xl mx-auto">
              It shouldn't be hard to study abroad from Sialkot. As education consultants in Sialkot, we help you every step of the way, from picking the perfect course and country to writing outstanding applications and filing an approved student visa. This keeps your trip straightforward, clear, and stress-free.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 px-8 py-4 text-lg">
                <a href="https://maps.app.goo.gl/dd9jMkjX1dzZ8tDr7" target="_blank" rel="noopener noreferrer" className="flex items-center">
                  Get Directions
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Right Side - Professional Office Gallery */}
            <motion.div
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
            ...
            >
              ...
              <div className="relative group">
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                  className="overflow-hidden rounded-2xl shadow-2xl bg-white border border-gray-100"
                >
                  <div className="relative">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="bg-white/95 backdrop-blur-sm rounded-lg p-3 shadow-lg">
                        <h4 className="font-bold text-gray-900 text-sm mb-1">Our Sialkot Office</h4>
                        <p className="text-gray-600 text-xs">2nd Floor, Bank Islami, Cantt Plaza</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-xl shadow-lg bg-white border border-gray-100"
                >
                  <img 
                  ...
                  <div className="absolute bottom-2 left-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="bg-white/90 backdrop-blur-sm rounded-md p-2">
                      <p className="text-gray-900 text-xs font-medium">Modern Workspace</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="absolute bottom-2 left-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="bg-white/90 backdrop-blur-sm rounded-md p-2">
                      <p className="text-gray-900 text-xs font-medium">Consultation Room</p>
                    </div>
                  </div>
                </motion.div>
              </div>
              ...
              <motion.div
                ...
                className="text-center"
              >
                <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-full border border-blue-100">
                  <div className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
                  <span className="text-sm font-medium text-gray-700">Open Mon-Sat 10 AM - 6 PM</span>
                </div>
              </motion.div>
            </motion.div>
          </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-[#1D50C9] relative">
                ...
                <div className="mt-8 text-center">
                  <p className="text-gray-600 text-sm">We'll map your profile to the right intake, entry requirements, and visa route</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Looking for the best consultant in Sialkot? Our process is transparent, deadline-driven, and designed for results.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Book your free consultation and start your study abroad Sialkot journey today.
            </p>
          </motion.div>
              ...
              <div className="bg-gradient-to-br from-[#1D50C9] to-[#1845B3] rounded-2xl p-8 text-white shadow-2xl flex flex-col" style={{minHeight: '600px'}}>
                ...
                <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                  <p className="text-blue-100 text-sm leading-relaxed">
                    Our process is transparent, deadline-driven, and designed for results. We provide comprehensive visa consultation services including document preparation, application processing, and pre-departure guidance for students planning to study abroad.
                  </p>
                </div>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <Button size="lg" variant="outline" className="w-full border-2 border-white text-white hover:bg-white/10 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-semibold">
                    <a href="https://maps.app.goo.gl/dd9jMkjX1dzZ8tDr7" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full">
                      Get Directions
                      <MapPin className="w-5 h-5 ml-2" />
                    </a>
                  </Button>
