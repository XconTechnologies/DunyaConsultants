...
export default function SialkotOffice() {
  const office = {
    ...
    email: "sialkot@dunyaconsultants.com",
    ...
    testimonials: [
      {
        ...
        message: "The Sialkot team provided excellent guidance for my Canadian study visa. Their professional approach was commendable."
      },
      {
        name: "Maria Tariq",
        university: "KU Leuven",
        message: "Outstanding support for my European university application. The team made the complex process very manageable."
      },
      {
        name: "Shahzad Ali",
        university: "McMaster University",
        message: "Professional and efficient service. They helped me achieve my dream of studying engineering in Canada."
      }
    ],
    facilities: ["Private Consultation Rooms", "Document Center", "Interview Preparation", "Student Waiting Area", "Free Internet", "Secure Parking", "Refreshments"],
    nearbyLandmarks: ["Sialkot Cantonment", "Sialkot Airport", "Sports Complex", "Cantt Golf Course", "Military Hospital", "Army Public School"]
  };
