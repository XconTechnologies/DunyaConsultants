...
export default function SheikhupuraOffice() {
  const office = {
    ...
    email: "sheikhupura@dunyaconsultants.com",
    hours: "Mon–Sat 10 AM–6 PM",
    gradient: "from-lime-600 to-green-600",
    region: "Punjab",
    services: ["University Applications", "Career Counseling", "IELTS Training", "Visa Processing", "Document Verification"],
    manager: "Mr. Hassan Ali",
    staffCount: 8,
    established: "2020",
    successRate: "92%",
    studentsServed: "1600+",
    specializations: ["Australian Universities", "UK Programs", "Medical Sciences", "Engineering Studies", "Information Technology"],
    description: "Strategically located near Stadium Road in Sheikhupura, our office serves the educational needs of students from this historic city with comprehensive guidance for Australian and UK universities, specializing in medical and engineering programs.",
    testimonials: [
      {
        name: "Omer Farooq",
        university: "University of Melbourne",
        message: "The Sheikhupura team provided excellent guidance for my Australian medical program. Their expertise in healthcare education was outstanding."
      },
      {
        name: "Zainab Sheikh",
        university: "Imperial College London",
        message: "Outstanding support for my UK engineering application. The team's technical knowledge and professionalism were impressive."
      },
      {
        name: "Adnan Malik",
        university: "University of Queensland",
        message: "Excellent consultation services. They helped me secure admission to my preferred IT program in Australia."
      }
    ],
    facilities: ["Medical Consultation Guidance", "Engineering Counseling", "IELTS Test Center", "Document Processing", "Student Waiting Area", "Free WiFi", "Parking Space"],
    nearbyLandmarks: ["Stadium Road", "Darul Barkat Hospital", "Sheikhupura Stadium", "Government College", "Civil Hospital", "Railway Station"]
  };
