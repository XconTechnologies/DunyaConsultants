...
export default function SheikhupuraOffice() {
  ...
  const services = [
    {
      ...
      description: "Find the best program and country that fits your abilities and objectives.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: GraduationCap,
      title: "University Selection",
      description: "Shortlists based on resources, profile, and when you want to start.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: FileText,
      title: "Application Handling",
      description: "Making sure that all documents, forms, and SOPs are ready on time.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Globe,
      title: "Visa Guidance",
      description: "Current checklists, file reviews, and interview preparation.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: MessageCircle,
      title: "Interview Preparation",
      description: "Practice interviews to help you feel more confident and get more approvals.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Calendar,
      title: "Pre-Departure Briefing",
      description: "Before you leave, get tips on travel, lodging, culture, and packing.",
      color: "from-blue-500 to-blue-600"
    }
  ];

  const ieltsFeatures = [
    "Experienced trainers for all four modules (LRWS)",
    "Modern teaching with easy, practical lessons",
    "Small batches for personal feedback and faster improvement",
    "Free assessment to know your current band and study plan",
  ...
  const whyChooseUs = [
    ...
    "Strong results: Proven admissions and visa approvals",
    "Local support: Easy follow-ups at our Sheikhupura office"
  ];
  ...
  const faqs = [
    {
      question: "Which countries can I apply to from Sheikhupura?",
      answer: "We can help you apply to the US, UK, Australia, Canada, Belgium, Cyprus, Germany, Turkey, Finland, and Ireland, as long as your profile and budget fit."
    },
    {
      question: "What documents do I need to start?",
      answer: "You will need your transcripts, passport, CV, SOP/personal statement, references, and financial/visa documents. We will give you a personalized checklist for your case."
    },
    {
      question: "When should I begin my application?",
      answer: "Start 6 to 9 months before your admission to get scholarships, offers, and a smooth migration process."
    },
    {
      question: "Do you offer IELTS prep in Sheikhupura?",
      answer: "Yes, you get professional trainers, smaller classes, innovative approaches, and an independent assessment to help you plan how to increase your score."
    },
    {
      question: "Will you help with visa files, and interviews?",
      answer: "Of course. We make a list of universities, get your visa file ready, and do practice interviews to help you feel more confident and get more approvals."
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center px-6 py-3 bg-white/15 rounded-full backdrop-blur-sm mb-8 border border-white/20">
              ...
              <span className="text-sm font-medium">Sheikhupura Office</span>
            </div>
            
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8 text-white">
              Dunya Consultants Sheikhupura | Study Abroad & Visa Experts
            </h1>
            
            <p className="text-xl lg:text-2xl mb-10 text-white leading-relaxed max-w-4xl mx-auto">
              Are you travelling to study abroad from Sheikhupura? We make it easy and stress-free. Our local experts will help you find the right pathway and country, get your application ready, and send in an outstanding visa file, step by step.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 px-8 py-4 text-lg">
                <a href="https://maps.app.goo.gl/UBa1pdSk4cKpaK5j8" target="_blank" rel="noopener noreferrer" className="flex items-center">
                  Get Directions
              ...
              <div className="bg-gradient-to-br from-[#1D50C9] to-[#1845B3] rounded-2xl p-8 text-white shadow-2xl flex flex-col" style={{minHeight: '600px'}}>
                ...
                <div className="space-y-4 flex-grow">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 leading-relaxed">
                        Besides Darul Barkat Medicare Hospital, Stadium Rd, Sheikhupura
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+923005071947" className="text-blue-100 hover:text-white transition-colors text-lg">
                        +92 300-5071947
                      </a>
                    </div>
                  </div>
                ...
                <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                  <p className="text-blue-100 text-sm leading-relaxed">
                    Our Sheikhupura office provides comprehensive visa consultation services including document preparation, application processing, and pre-departure guidance for students planning to study abroad.
                  </p>
                </div>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <Button size="lg" variant="outline" className="w-full border-2 border-white text-white hover:bg-white/10 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-semibold">
                    <a href="https://maps.app.goo.gl/UBa1pdSk4cKpaK5j8" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full">
                      Get Directions
                      <MapPin className="w-5 h-5 ml-2" />
                    </a>
                  </Button>
