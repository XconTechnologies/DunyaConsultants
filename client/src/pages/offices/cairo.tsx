...
export default function CairoOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Cairo Office",
      "Expert study abroad consultants in Cairo helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
  ...
  const services = [
    {
      ...
      description: "From Cairo, we help you shortlist the right programs that match your career goals and academic background. Our expert counselors provide personalized guidance for your study abroad journey.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: GraduationCap,
      title: "University Shortlisting",
      description: "We help you select the best universities and programs based on your profile, budget, and preferences. Our team has extensive knowledge of international universities and their requirements.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: FileText,
      title: "Application Support",
      description: "Complete application support including document preparation, form filling, and statement of purpose assistance. We ensure all applications are submitted correctly and on time.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Globe,
      title: "Visa Guidance",
      description: "End-to-end visa file building with comprehensive guidance through the entire visa process. Our experts ensure your visa application meets all requirements for success.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: MessageCircle,
      title: "Pre-Departure Support",
      description: "Complete pre-departure briefing covering travel arrangements, accommodation, cultural preparation, and everything you need to know before starting your international education journey.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Calendar,
      title: "Test Preparation",
      description: "Focused coaching for IELTS, TOEFL, PTE, and Duolingo with a personal study plan. Free assessment to determine your current level and create targeted improvement strategies.",
      color: "from-blue-500 to-blue-600"
    }
  ];

  const ieltsFeatures = [
    "IELTS, TOEFL, PTE, DET coaching with free assessment",
    "Personal study plan tailored to your needs",
    "Experienced trainers with proven track record",
    "Small class sizes for personalized attention",
    "Mock tests and performance tracking"
  ];

  const whyChooseUs = [
    "Personalised plans for each student",
    "Clear timelines and structured process",
    "Strong track record of successful visas",
    "Local and online access available",
  ...
  const faqs = [
    {
      ...
      answer: "Yes, we advise on university, government, and external awards."
    },
    {
      question: "Do you help with statements of purpose?",
      answer: "Yes, we review and edit SOPs for admissions and visas."
    },
    {
      question: "Is an English test required?",
      answer: "It depends. Some courses accept PTE, Duolingo."
    },
    {
      question: "How long does the process take?",
      answer: "Offers and visas vary. Apply 6 to 9 months in advance."
    },
    {
      question: "Can I get online support?",
      answer: "Yes, by phone, WhatsApp, or video."
    },
    {
      question: "What makes Dunya Consultants Cairo special?",
      answer: "Our Cairo office provides personalized study abroad guidance with clear timelines, strong track record, and both local and online support to help Egyptian students achieve their international education dreams."
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center px-6 py-3 bg-white/15 rounded-full backdrop-blur-sm mb-8 border border-white/20">
              ...
              <span className="text-sm font-medium">Cairo Office</span>
            </div>
            
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8 text-white">
              Dunya Consultants, Cairo (Egypt)
            </h1>
            
            <p className="text-xl lg:text-2xl mb-10 text-white leading-relaxed max-w-4xl mx-auto">
              Study Abroad and Student Visa Experts. From Cairo, we help you shortlist the right programs, prepare strong applications, and submit a complete student visa file. We keep the process clear and on schedule.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 px-8 py-4 text-lg">
                <a href="https://maps.app.goo.gl/YourCairoLocationLink" target="_blank" rel="noopener noreferrer" className="flex items-center">
                  Get Directions
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Career counselling, university shortlisting, application support, visa guidance, and pre-departure support.
            </p>
          </motion.div>
              ...
              <CardContent className="p-12 text-center relative">
                ...
                <div className="relative">
                  ...
                  <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
                    Book a free consultation and start your study abroad plan from Cairo with our expert guidance and proven success methods.
                  </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              If you're searching for education consultants in Cairo for study abroad guidance, we're here to help. Visit us today for a free consultation and take the first step toward your dream university abroad.
            </p>
          </motion.div>
              ...
              <div className="bg-gradient-to-br from-[#1D50C9] to-[#1845B3] rounded-2xl p-8 text-white shadow-2xl flex flex-col" style={{minHeight: '600px'}}>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 leading-relaxed">
                        Zahraa Maadi, Carrefour street, Grand Plaza Tower 5th floor Office No #508 Cairo, Egypt
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                  <p className="text-blue-100 text-sm leading-relaxed">
                    Our Cairo office provides comprehensive study abroad guidance including university selection, application support, IELTS preparation, and complete visa filing services for Egyptian students.
                  </p>
                </div>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <Button size="lg" variant="outline" className="w-full border-2 border-white text-white hover:bg-white/10 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-semibold">
                    <a href="https://maps.app.goo.gl/YourCairoLocationLink" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full">
                      Get Directions
                      <MapPin className="w-5 h-5 ml-2" />
                    </a>
                  </Button>
