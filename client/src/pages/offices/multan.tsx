...
export default function MultanOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Multan Office",
      "Expert study abroad consultants in Multan helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
  ...
  const services = [
    {
      ...
      description: "Find the perfect program and country that fit your unique abilities and dreams with personalized guidance from our Multan experts.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: GraduationCap,
      title: "University Selection",
      description: "Make a list of universities based on your profile, budget, and intake with our comprehensive database of international institutions.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: FileText,
      title: "Application Handling",
      description: "Making sure that documents, forms, and SOPs are filled out correctly and sent in on schedule with expert review.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Globe,
      title: "Visa Guidance",
      description: "Current checklists, file reviews, and getting ready for interviews with up-to-date visa requirements and procedures.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: MessageCircle,
      title: "Interview Preparation",
      description: "Practice sessions and confidence building to help you excel in university admissions and visa interviews.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Calendar,
      title: "Pre-Departure Briefing",
      description: "Tips for packing, travelling, staying in accommodations, and learning about other cultures for a smooth transition.",
      color: "from-blue-500 to-blue-600"
    }
  ];

  const ieltsFeatures = [
    "Experienced Trainers – Learn from skilled and friendly instructors in Multan",
    "Modern Teaching Style – Easy lessons that make IELTS preparation simple and effective",
    "Small Batches – Personalized input and faster improvement with focused attention",
    "Free Assessment – Find out what your current band is and make a suited study plan",
    "End-to-end Support – All the help you need, from IELTS to acceptance to a visa, all in one place"
  ];

  const whyChooseUs = [
    "Expert guidance from qualified advisors in Multan",
    "Personalized plans that fit your needs and goals",
    "Proven results with strong record of admissions and visas",
    "Local support at our easily accessible Multan office",
    "Comprehensive support from consultation to visa approval"
  ];
  ...
  const faqs = [
    {
      question: "Which countries can I apply to from Multan?",
      answer: "We process applications for the US, UK, Australia, Canada, Belgium, Cyprus, Germany, Turkey, Finland, and Ireland according to your budget, profile, and intake."
    },
    {
      question: "What documents do I need to start?",
      answer: "You will need your transcripts, passport, English exam (if required), CV, SOP/personal statement, references, and financial/visa documents. We'll provide you with a customized checklist for your situation."
    },
    {
      question: "When should I begin my study-abroad process?",
      answer: "Start 6 to 9 months before your goal intake to acquire offers, and an easy immigration process."
    },
    {
      question: "Do you offer IELTS classes in Multan?",
      answer: "Yes, there are experienced trainers, small groups, and a free assessment. We also suggest test alternatives when they are allowed."
    },
    {
      question: "Will you help with visa files, and interviews?",
      answer: "Of course. We make a list of universities, put together a visa file that meets all the requirements, and do practice interviews to help people feel more confident and likely to get approved."
    },
    {
      question: "What makes Dunya Consultants Multan different?",
      answer: "We provide end-to-end support from our local Multan office, with experienced advisors who understand the unique needs of students from southern Punjab."
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center px-6 py-3 bg-white/15 rounded-full backdrop-blur-sm mb-8 border border-white/20">
              ...
              <span className="text-sm font-medium">Multan Office</span>
            </div>
            
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-[1.5rem] mb-8 text-white">
              Dunya Consultants Multan | Study Abroad & Student Visa Experts
            </h1>
            
            <p className="text-xl lg:text-2xl mb-10 text-white leading-relaxed max-w-4xl mx-auto">
              Are you thinking of studying abroad from Multan? We make the procedure easy and stress-free. Our local experts will help you pick the proper course and country, write good applications, and file a student visa that meets all the rules.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 px-8 py-4 text-lg">
                <a href="https://maps.app.goo.gl/E44uevHRMJcaccJA9" target="_blank" rel="noopener noreferrer" className="flex items-center">
                  Get Directions
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Achieve your dream IELTS score with our comprehensive training program designed for success in Multan
            </p>
          </motion.div>
              ...
              <CardContent className="p-12 text-center relative">
                ...
                <div className="relative">
                  ...
                  <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
                    Join hundreds of successful students who achieved their target scores with our expert guidance and proven teaching methods in Multan.
                  </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              If you're searching for study abroad consultants in Multan, we're here to help. Visit us today for a free consultation and take the first step toward your dream university abroad.
            </p>
          </motion.div>
              ...
              <div className="bg-gradient-to-br from-[#1D50C9] to-[#1845B3] rounded-2xl p-8 text-white shadow-2xl flex flex-col" style={{minHeight: '600px'}}>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 leading-relaxed">
                        Shalimar Metro Station, Bosan Rd, New Sabzazar Colony, Multan
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                  <p className="text-blue-100 text-sm leading-relaxed">
                    Our Multan office provides comprehensive visa consultation services including document preparation, application processing, and pre-departure guidance for students planning to study abroad.
                  </p>
                </div>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <Button size="lg" variant="outline" className="w-full border-2 border-white text-white hover:bg-white/10 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-semibold">
                    <a href="https://maps.app.goo.gl/E44uevHRMJcaccJA9" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full">
                      Get Directions
                      <MapPin className="w-5 h-5 ml-2" />
                    </a>
                  </Button>
