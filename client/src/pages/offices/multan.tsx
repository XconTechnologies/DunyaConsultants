...
export default function MultanOffice() {
  const office = {
    ...
    email: "multan@dunyaconsultants.com",
    hours: "Mon–Sat 10 AM–6 PM",
    gradient: "from-red-600 to-rose-600",
    region: "Punjab",
    services: ["Visa Processing", "University Applications", "Document Verification", "Test Preparation", "Career Counseling"],
    manager: "Mr. Kaleem Ullah",
    staffCount: 12,
    established: "2018",
    successRate: "95%",
    studentsServed: "3200+",
    specializations: ["UK Universities", "Australian Programs", "Medical Sciences", "Business Studies", "Agricultural Sciences"],
    description: "Located near Shalimar Metro Station in the historic city of Multan, our office serves southern Punjab with comprehensive educational consultancy services, specializing in UK and Australian universities with strong focus on medical and agricultural programs.",
    testimonials: [
      {
        name: "Dr. Amna Javed",
        university: "Queen Mary University",
        message: "The Multan team provided exceptional guidance for my medical program in the UK. Their understanding of healthcare education was remarkable."
      },
      {
        name: "Tariq Mahmood",
        university: "University of Sydney",
        message: "Outstanding support for my Australian agricultural sciences program. The team's expertise in this field was impressive."
      },
      {
        name: "Saira Batool",
        university: "University of Birmingham",
        message: "Professional service throughout my UK business program application. They made the entire process smooth and efficient."
      }
    ],
    facilities: ["Metro Accessibility", "Medical Program Guidance", "Agricultural Counseling", "Document Center", "Test Prep Area", "Student Lounge", "Parking Available"],
    nearbyLandmarks: ["Shalimar Metro Station", "Bosan Road", "New Sabzazar Colony", "Multan Cricket Stadium", "Shah Rukn-e-Alam Shrine", "General Hospital"]
  };
