...
export default function IslamabadBlueArea() {
  const [isFormOpen, setIsFormOpen] = useState(false);
  
  useEffect(() => {
    setStaticPageMeta(
      "Islamabad Blue Area Office",
      "Expert study abroad consultants in Islamabad Blue Area helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
  const office = {
    id: "islamabad",
    ...
    region: "Federal",
    services: ["Visa Processing", "Embassy Relations", "Document Attestation", "University Applications", "Career Counseling"],
    manager: "Mr. Usman Ali",
    established: "2018",
    specializations: ["US Universities", "Embassy Liaison", "Government Documentation", "Diplomatic Services", "Canada Immigration"],
    ...
    testimonials: [
      ...
      },
      {
        ...
        message: "Exceptional guidance for my Canadian study permit. The team's expertise in embassy procedures was invaluable."
      },
      {
        name: "Fatima Ali",
        university: "Stanford University",
        message: "Outstanding support throughout my US university application. The Islamabad office team made my dream come true."
      }
    ],
    facilities: ["Embassy Liaison Desk", "Government Documentation", "VIP Consultation", "Conference Room", "Digital Services", "Private Meetings", "Document Verification"],
    nearbyLandmarks: ["US Embassy", "UK High Commission", "Parliament House", "Supreme Court", "Diplomatic Enclave", "Serena Hotel"]
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {/* Call to Action */}
        <motion.div
          className="mt-16 bg-gradient-to-r from-[#1D50C9] to-[#1845B3] rounded-2xl p-8 text-white text-center"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.5 }}
        >
          <h2 className="text-2xl font-bold mb-4">Connect with Diplomatic Excellence</h2>
          <p className="mb-6 opacity-90">
            Visit our Islamabad office for specialized embassy relations and US university admissions support.
          </p>
