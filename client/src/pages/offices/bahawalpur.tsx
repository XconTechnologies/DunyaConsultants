...
export default function BahawalpurOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Bahawalpur Office",
      "Expert study abroad consultants in Bahawalpur helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
  ...
  const services = [
    {
      ...
      description: "Match your goals and budget to the right program and country. Our advisors at Bahawalpur help you choose the perfect course and country.",
    ...
    },
    {
      ...
      description: "Documents, forms, and SOPs made on time and accurately. We prepare your documents, fill out forms, and make sure everything is submitted on time.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Globe,
      title: "Visa Guidance",
      description: "Up-to-date checklists, file review, and interview prep. Our study visa experts at Bahawalpur follow the process with greatest care.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: MessageCircle,
  ...
  const ieltsFeatures = [
    ...
    "Modern teaching with practical tasks and simple explanations – Easy lessons that actually make sense",
    ...
    "End-to-end support: IELTS, admission, and a visa all in one place – A supportive environment with the latest facilities"
  ];
  ...
  const whyChooseUs = [
    ...
    "Local support: Easy follow-ups at our Bahawalpur office",
  ...
  const faqs = [
    {
      question: "Which countries can I apply to from Bahawalpur?",
      answer: "We process applications for the USA, UK, Australia, Canada, Belgium, Cyprus, Germany, Turkey, Finland, and Ireland, matched to your profile and budget."
    },
    {
      question: "Can I apply to the UK without IELTS?",
      answer: "Some universities accept IELTS alternatives (e.g., PTE, Duolingo) or offer pathway options. We'll shortlist options that fit your profile and guide you on requirements."
    },
    {
      question: "Do you review the SOP for Australia student visas?",
      answer: "Yes. We help structure and refine your SOP for Australia student visa, aligning it with course rationale, GTE/GS criteria, and supporting evidence."
    },
    {
      question: "Do you guide on scholarships like Türkiye Bursları?",
      answer: "Absolutely. We advise on Türkiye Bursları (Turkish Government Scholarship) and other country/university awards with timelines, documents, and profile strengthening."
    },
    {
      question: "What about updates on IELTS classes and test fees?",
      answer: "We run IELTS classes in Bahawalpur and share the latest IELTS test fee guidance in Pakistan, plus a study plan based on your free assessment."
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center px-6 py-3 bg-white/15 rounded-full backdrop-blur-sm mb-8 border border-white/20">
              ...
              <span className="text-sm font-medium">Bahawalpur Office</span>
            </div>
            
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8 text-white">
              Study Abroad Consultants in Bahawalpur | Student Visa & IELTS Guidance
            </h1>
            
            <p className="text-xl lg:text-2xl mb-10 text-white leading-relaxed max-w-4xl mx-auto">
              Planning to study abroad from Bahawalpur shouldn't feel complicated. As local education consultants in Bahawalpur, we help with every step of the way, from choosing the correct course and country to submitting solid applications and filing a student visa that meets all the requirements.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 px-8 py-4 text-lg">
                <a href="https://maps.app.goo.gl/HYdRtM5CTJC3msE19" target="_blank" rel="noopener noreferrer" className="flex items-center">
                  Get Directions
            ...
            <div className="text-center">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-[#1D50C9] relative">
                ...
                <div className="mt-8 text-center">
                  <p className="text-gray-600 text-sm">We map your profile to entry requirements, intakes, and visa routes</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              This keeps your trip simple, clear, and stress-free with our transparent process.
            </p>
          </motion.div>
              ...
              <CardContent className="p-12 text-center relative">
                ...
                <div className="relative">
                  ...
                  <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
                    Book your free consultation and start your study abroad Bahawalpur journey today.
                  </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              If you're searching for study abroad consultants in Bahawalpur, we're here to help. Visit us today for a free consultation and take the first step toward your dream university abroad.
            </p>
          </motion.div>
              ...
              <div className="bg-gradient-to-br from-[#1D50C9] to-[#1845B3] rounded-2xl p-8 text-white shadow-2xl flex flex-col" style={{minHeight: '600px'}}>
                ...
                <div className="space-y-4 flex-grow">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 leading-relaxed">
                        Rafi Qamar Road, near Muslim Town, Goth Muslim Town, Bahawalpur
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+923001731947" className="text-blue-100 hover:text-white transition-colors text-lg">
                        +92 300-1731947
                      </a>
                    </div>
                  </div>
                ...
                <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                  <p className="text-blue-100 text-sm leading-relaxed">
                    Our Bahawalpur office provides comprehensive visa consultation services including document preparation, application processing, and pre-departure guidance for students planning to study abroad.
                  </p>
                </div>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <Button size="lg" variant="outline" className="w-full border-2 border-white text-white hover:bg-white/10 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-semibold">
                    <a href="https://maps.app.goo.gl/HYdRtM5CTJC3msE19" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full">
                      Get Directions
                      <MapPin className="w-5 h-5 ml-2" />
                    </a>
                  </Button>
