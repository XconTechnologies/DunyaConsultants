...
export default function BahawalpurOffice() {
  const office = {
    ...
    email: "bahawalpur@dunyaconsultants.com",
    hours: "Mon–Sat 10 AM–6 PM",
    gradient: "from-violet-600 to-purple-600",
    region: "Punjab",
    services: ["Visa Processing", "Test Preparation", "Document Preparation", "University Applications", "Career Counseling"],
    manager: "Ms. Farah Noor",
    staffCount: 7,
    established: "2020",
    successRate: "90%",
    studentsServed: "1500+",
    specializations: ["Middle Eastern Universities", "European Programs", "Agricultural Sciences", "Engineering Programs", "Islamic Studies"],
    description: "Located in the historic city of Bahawalpur, our office serves students from southern Punjab with specialized guidance for Middle Eastern and European universities, with particular expertise in agricultural and Islamic studies programs.",
    testimonials: [
      {
        name: "Muhammad Yasir",
        university: "Al-Azhar University",
        message: "The Bahawalpur team provided exceptional guidance for my Islamic studies program in Egypt. Their knowledge was invaluable."
      },
      {
        name: "Sadia Rehman",
        university: "University of Agriculture, Vienna",
        message: "Outstanding support for my agricultural sciences application. The team understood my field perfectly."
      },
      {
        name: "Ali Haider",
        university: "Istanbul Technical University",
        message: "Professional service throughout my Turkish university application. They made the process very smooth."
      }
    ],
    facilities: ["Consultation Rooms", "Document Center", "Test Preparation Area", "Prayer Room", "Student Lounge", "Free Internet", "Parking Space"],
    nearbyLandmarks: ["Muslim Town", "Rafi Qamar Road", "Bahawalpur Stadium", "Government College", "Civil Hospital", "Railway Station"]
  };
