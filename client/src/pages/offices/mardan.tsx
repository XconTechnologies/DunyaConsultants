...
export default function MardanOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Mardan Office",
      "Expert study abroad consultants in Mardan helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center px-6 py-3 bg-white/15 rounded-full backdrop-blur-sm mb-8 border border-white/20">
              ...
              <span className="text-sm font-medium">Mardan Office</span>
            </div>
            
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-[1.5rem] mb-8 text-white">
              Dunya Consultants Mardan | Study Abroad & Visa Experts
            </h1>
            
            <p className="text-xl lg:text-2xl mb-10 text-white leading-relaxed max-w-4xl mx-auto">
              Planning to study abroad from Mardan? We make it simple and stress-free. Our local team helps you choose the right course and country, prepare strong applications, and submit a compliant student-visa file—step by step.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 px-8 py-4 text-lg">
                <a href="https://maps.app.goo.gl/YourMardanLocationLink" target="_blank" rel="nofollow noopener noreferrer" className="flex items-center">
                  Get Directions
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              If you're searching for study abroad consultants in Mardan, we're here to help. Visit us today for a free consultation and take the first step toward your dream university abroad.
            </p>
          </motion.div>
              ...
              <div className="bg-gradient-to-br from-[#1D50C9] to-[#1845B3] rounded-2xl p-8 text-white shadow-2xl flex flex-col" style={{minHeight: '600px'}}>
                ...
                <div className="space-y-4 flex-grow">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 leading-relaxed">
                        2nd Floor, Office Unit A, Walyan Commercial Centre, Nowshera Road, Mardan
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+923171114617" className="text-blue-100 hover:text-white transition-colors text-lg">
                        +92 317-1114617
                      </a>
                    </div>
                  </div>
                ...
                <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                  <p className="text-blue-100 text-sm leading-relaxed">
                    Our Mardan office provides comprehensive visa consultation services including document preparation, application processing, and pre-departure guidance for students planning to study abroad.
                  </p>
                </div>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <Button size="lg" variant="outline" className="w-full border-2 border-white text-white hover:bg-white/10 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-semibold">
                    <a href="https://maps.app.goo.gl/YourMardanLocationLink" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full">
                      Get Directions
                      <MapPin className="w-5 h-5 ml-2" />
                    </a>
                  </Button>
