        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6 text-center">
                <h4 className="font-bold text-gray-900 mb-2">The UK</h4>
                <p className="text-sm text-gray-600">Home to centuries-old universities and iconic campuses</p>
              </CardContent>
            </Card>
            
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6 text-center">
                <h4 className="font-bold text-gray-900 mb-2">The USA</h4>
                <p className="text-sm text-gray-600">Where endless specializations meet vibrant campus life</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">Combining top-tier education with post-study work options</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">Renowned for research and quality of life</p>
              </CardContent>
            </Card>
          </div>
        </div>
