...
export default function GujranwalaOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Gujranwala Office",
      "Expert study abroad consultants in Gujranwala helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
