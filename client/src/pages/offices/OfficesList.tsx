...
export default function OfficesList() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      <Navigation />
      {/* Header */}
      <div className="text-white pt-32 pb-16" style={{ background: `linear-gradient(to right, #1E50CA, #1e50c7)` }}>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {(selectedRegion === 'all' || selectedRegion !== 'International') && pakistanOffices.length > 0 && (
          ...
          >
            <div className="flex items-center mb-8">
              ...
              <div className="px-6">
                <h2 className="text-3xl font-bold text-gray-800 text-center" style={{ color: '#1E50CA' }}>
                  Pakistan Offices
                </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {internationalOffices.map((office, index) => (
                <motion.div
                  ...
                  transition={{ duration: 0.6, delay: index * 0.1 }}
                >
                  <Card className="h-full hover:shadow-xl transition-all duration-300 group cursor-pointer" style={{ borderColor: '#1E50CA' }}>
                    <div className={`h-2 bg-gradient-to-r ${office.gradient}`}></div>
                    <CardContent className="p-6">
                      {/* Header */}
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            <h3 className="text-xl font-bold text-gray-800">{office.city}</h3>
                            <Badge className="text-white text-xs" style={{ backgroundColor: '#1E50CA' }}>
                              International
                            </Badge>
                          </div>
                          <p className="text-gray-600 font-medium">{office.name}</p>
                          <Badge variant="outline" className="text-xs mt-1" style={{ borderColor: '#1E50CA', color: '#1E50CA' }}>
                            {office.region}
                          </Badge>
                        </div>
                        <div className="w-12 h-12 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300" style={{ backgroundColor: '#1E50CA' }}>
                          <Building2 className="w-6 h-6 text-white" />
                        </div>
                      </div>
                      ...
                      <div className="space-y-3 mb-4">
                        <div className="flex items-start space-x-3">
                          <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#1E50CA' }} />
                          <p className="text-sm text-gray-600 leading-relaxed">{office.address}</p>
                        </div>
                        <div className="flex items-center space-x-3">
                          <Phone className="w-4 h-4 flex-shrink-0" style={{ color: '#1E50CA' }} />
                          <a href={`tel:${office.phone}`} className="text-sm hover:underline" style={{ color: '#1E50CA' }}>
                            {office.phone}
                          </a>
                        </div>
                        <div className="flex items-center space-x-3">
                          <Clock className="w-4 h-4 flex-shrink-0" style={{ color: '#1E50CA' }} />
                          <p className="text-sm text-gray-600">{office.hours}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Button 
                          ...
                          style={{ borderColor: '#1E50CA', color: '#1E50CA' }}
                        >
                          <Phone className="w-3 h-3 mr-1" />
                          Call
                        </Button>
        ...
        <motion.div
          ...
          style={{ background: `linear-gradient(to right, #1E50CA, #1e50c7)` }}
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.4 }}
        >
