...
export default function KarachiGulshan() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      ...
      "Expert study abroad consultants in Karachi Gulshan helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
  const office = {
    id: "karachi",
