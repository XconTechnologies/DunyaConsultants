...
export default function GujratOffice() {
  const office = {
    ...
    email: "gujrat@dunyaconsultants.com",
    hours: "Mon–Sat 10 AM–6 PM",
    gradient: "from-rose-600 to-pink-600",
    region: "Punjab",
    services: ["University Applications", "IELTS Training", "Career Counseling", "Visa Processing", "Document Preparation"],
    manager: "Mr. Imran Sheikh",
    staffCount: 9,
    established: "2019",
    successRate: "91%",
    studentsServed: "2000+",
    specializations: ["UK Universities", "Australian Programs", "Information Technology", "Business Studies", "Medical Sciences"],
    description: "Serving the pottery capital of Pakistan, our Gujrat office provides comprehensive educational consultancy services with expertise in technology and business programs for international study.",
    testimonials: [
      {
        name: "Zara Ahmad",
        university: "University of Sydney",
        message: "The Gujrat team provided excellent guidance for my Australian IT program. Their technical knowledge was impressive."
      },
      {
        name: "Kashif Malik",
        university: "University of Birmingham",
        message: "Outstanding support throughout my UK application process. The team made everything smooth and professional."
      },
      {
        name: "Ayesha Butt",
        university: "RMIT University",
        message: "Excellent consultation services. They helped me achieve my goal of studying business in Australia."
      }
    ],
    facilities: ["Modern Consultation Rooms", "IELTS Test Center", "Document Processing", "Student Lounge", "Free WiFi", "Parking Facility", "Refreshment Area"],
    nearbyLandmarks: ["GT Road", "KFC Gujrat", "Service Morh", "District Courts", "Government College", "General Hospital Gujrat"]
  };
