...
export default function FaisalabadOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Faisalabad Office",
      "Expert study abroad consultants in Faisalabad helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
  ...
  const services = [
    {
      ...
      description: "Align your goals and budget with the right programs and destinations. Our advisors at Faisalabad help you choose the perfect course and country for your future.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: GraduationCap,
      title: "University Shortlisting",
      description: "Choices matched to your academic profile, eligibility, and intake timeline. We work with multiple top ranked universities worldwide.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: FileText,
      title: "Application Support",
      description: "Documents, forms, and SOP/statement of purpose prepared correctly and on time. We make sure everything is submitted properly.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Globe,
      title: "Visa Guidance",
      description: "Up-to-date checklists, file review, and mock interviews. Our study visa experts at Faisalabad follow the process with greatest care.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: MessageCircle,
      title: "Interview Preparation",
      description: "We conduct practice interviews, provide practical advice, and boost your confidence to help you perform at your best.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Calendar,
      title: "Pre-Departure Briefing",
      description: "Travel, accommodation, culture, and packing tips. We ensure a smooth start to your new adventure abroad.",
      color: "from-blue-500 to-blue-600"
    }
  ];
  ...
  const ieltsFeatures = [
    ...
    "Modern Teaching Style – With practical tasks and clear feedback",
    "Small Class Sizes – Personal attention for better results",
    "Free IELTS Assessment – Tailored study plan for you",
    "End-to-End Support – IELTS + admission + visa under one roof"
  ];

  const whyChooseUs = [
    "Expert guidance with friendly, qualified counsellors",
    "Personalized plans with advice tailored to you", 
    "Proven results with strong track record in admissions and visas",
    "Local access with easy follow-ups at our Faisalabad office",
    "Transparent, timeline-driven, and results-focused process"
  ];
  ...
  const faqs = [
    {
      question: "What services do your education consultants in Faisalabad provide?",
      answer: "Our team offers end to end career & course consultation, university shortlisting, application filing, student-visa guidance, scholarship advice, IELTS coaching in Faisalabad, and pre-departure support."
    },
    {
      question: "Which countries can I apply to through your study abroad Faisalabad office?",
      answer: "We process applications for the USA, UK, Australia, Canada, Belgium, Cyprus, Germany, Turkey, Finland, and Ireland, matching each profile to the right intake and visa route."
    },
    {
      question: "Is IELTS compulsory, and do you offer IELTS coaching in Faisalabad?",
      answer: "Many universities prefer IELTS, but some accept PTE/Duolingo/TOFEL. We run small-batch IELTS classes in Faisalabad with a free assessment and a custom study plan."
    },
    {
      question: "What documents do student visa consultants in Faisalabad need to start my case?",
      answer: "Bring your transcripts, passport, English test (if required), CV, SOP/personal statement, references, and financial/visa documents. We'll share a custom checklist for your situation."
    },
    {
      question: "When should I start my overseas education application?",
      answer: "Begin 6–9 months before your target intake to secure offers, scholarships, and a smooth visa timeline with fewer last-minute risks."
    },
    {
      question: "Do you help with scholarships and budgeting?",
      answer: "Yes! our admission consultants in Faisalabad shortlist relevant university/government awards and guide you on tuition, living costs, and payment timelines."
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center px-6 py-3 bg-white/15 rounded-full backdrop-blur-sm mb-8 border border-white/20">
              ...
              <span className="text-sm font-medium">Faisalabad Office</span>
            </div>
            
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-[1.5rem] mb-8 text-white">
              Overseas Education, Admissions & Student Visa Services Faisalabad
            </h1>
            
            <p className="text-xl lg:text-2xl mb-10 text-white leading-relaxed max-w-4xl mx-auto">
              Looking for study abroad options in Faisalabad? We make your journey simple, clear, and stress-free. Our local team helps you step by step to choose the right course and country, prepare strong applications, and submit a compliant student visa.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 px-8 py-4 text-lg">
                <a href="https://maps.app.goo.gl/e4cEbfQ6HDYFGhhs7" target="_blank" rel="noopener noreferrer" className="flex items-center">
                  Get Directions
            ...
            <div className="text-center">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-[#1D50C9] relative">
                ...
                <div className="mt-8 text-center">
                  <p className="text-gray-600 text-sm">We also advise on accepted English test alternatives (PTE/Duolingo/MOI) where applicable</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Looking for the best consultancy in Faisalabad? Our process is transparent, timeline-driven, and focused on results.
            </p>
          </motion.div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Experienced trainers for Listening, Reading, Writing, Speaking with modern teaching methods
            </p>
          </motion.div>
              ...
              <CardContent className="p-12 text-center relative">
                ...
                <div className="relative">
                  ...
                  <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
                    Book your free consultation and start your study abroad Faisalabad journey today.
                  </p>
