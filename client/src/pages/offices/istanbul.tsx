...
export default function IstanbulOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Istanbul Office",
      "Expert study abroad consultants in Istanbul helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
  ...
  const services = [
    {
      ...
      description: "Match your career goals with the right program and country. Our advisors in Istanbul sit down with you, understand your aspirations, and suggest the best study options for your future.",
    ...
    },
    {
      icon: Globe,
      title: "Visa Guidance",
      description: "Visa guidance, checklists, file review, and mock interviews. Our visa experts in Istanbul follow the process with greatest care to ensure your success.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: MessageCircle,
  ...
  const faqs = [
    ...
    {
      question: "Which countries do you support from Istanbul?",
    ...
    {
      question: "What makes Dunya Consultants Istanbul special?",
      answer: "Our local team understands the unique needs of Turkish students and international students in Istanbul. We provide personalized guidance with proven results and both local and online support."
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center px-6 py-3 bg-white/15 rounded-full backdrop-blur-sm mb-8 border border-white/20">
              ...
              <span className="text-sm font-medium">Istanbul Office</span>
            </div>
            
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8 text-white">
              Dunya Consultants | Istanbul (Türkiye)
            </h1>
            
            <p className="text-xl lg:text-2xl mb-10 text-white leading-relaxed max-w-4xl mx-auto">
              Planning to study abroad from Istanbul? We guide you from choosing a course and country to submitting strong applications and a compliant student visa. The goal is to make everything simple and stress free.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 px-8 py-4 text-lg">
                <a href="https://maps.app.goo.gl/YourIstanbulLocationLink" target="_blank" rel="noopener noreferrer" className="flex items-center">
                  Get Directions
              ...
              <CardContent className="p-12 text-center relative">
                ...
                <div className="relative">
                  ...
                  <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
                    Book your free consultation and start your study abroad Istanbul journey with our expert guidance and proven success methods.
                  </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              If you're searching for study abroad consultants in Istanbul, we're here to help. Visit us today for a free consultation and take the first step toward your dream university abroad.
            </p>
          </motion.div>
              ...
              <div className="bg-gradient-to-br from-[#1D50C9] to-[#1845B3] rounded-2xl p-8 text-white shadow-2xl flex flex-col" style={{minHeight: '600px'}}>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100 leading-relaxed">
                        Ataköy Towers İstanbul, Ataköy 7-8-9-10. Kısım Mah. Çobançeşme E-5 Yan Yol Cad. Ataköy Towers A Blok Apt. No: 20/1 Bakırköy / İstanbul, Istanbul, Turkey
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                  <p className="text-blue-100 text-sm leading-relaxed">
                    Our Istanbul office provides comprehensive visa consultation services including document preparation, application processing, and pre-departure guidance for students planning to study abroad.
                  </p>
                </div>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <Button size="lg" variant="outline" className="w-full border-2 border-white text-white hover:bg-white/10 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-semibold">
                    <a href="https://maps.app.goo.gl/YourIstanbulLocationLink" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full">
                      Get Directions
                      <MapPin className="w-5 h-5 ml-2" />
                    </a>
                  </Button>
