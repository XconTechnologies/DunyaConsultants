...
export default function MianChannuOffice() {
  const office = {
    ...
    email: "mianchannu@dunyaconsultants.com",
    hours: "Mon–Sat 10 AM–6 PM",
    gradient: "from-teal-600 to-cyan-600",
    region: "Punjab",
    services: ["Student Counseling", "University Applications", "Career Guidance", "Visa Processing", "Document Verification"],
    manager: "Mr. Shahid Hussain",
    staffCount: 6,
    established: "2021",
    successRate: "89%",
    studentsServed: "1200+",
    specializations: ["Agricultural Universities", "Canadian Programs", "Engineering Studies", "Business Administration", "Environmental Sciences"],
    description: "Serving the agricultural heartland of Punjab, our Mian Channu office specializes in agricultural and environmental science programs, providing expert guidance for students from rural areas seeking international education opportunities.",
    testimonials: [
      {
        name: "Farrukh Ahmad",
        university: "University of Guelph",
        message: "The Mian Channu team understood my agricultural background perfectly and helped me secure admission to a top Canadian agricultural program."
      },
      {
        name: "Kiran Batool",
        university: "University of Saskatchewan",
        message: "Excellent guidance for my environmental sciences program. The team's knowledge of agricultural fields was impressive."
      },
      {
        name: "Naveed Khan",
        university: "Dalhousie University",
        message: "Professional service from start to finish. They helped me transition from rural Pakistan to Canadian university life."
      }
    ],
    facilities: ["Agricultural Consultation", "Document Processing", "Career Counseling Room", "Student Support Center", "Free WiFi", "Parking Area", "Refreshment Corner"],
    nearbyLandmarks: ["Moti Plaza", "Allama Iqbal Road", "District Hospital", "Government College", "Agriculture Department", "Tehsil Office"]
  };
