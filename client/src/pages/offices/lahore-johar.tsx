...
export default function LahoreJohar() {
  const office = {
    ...
    email: "lahore.johar@dunyaconsultants.com",
    hours: "Mon–Sat 10 AM–6 PM",
    gradient: "from-orange-600 to-red-600",
    region: "Punjab",
    services: ["Student Counseling", "Test Preparation", "Career Guidance", "University Applications", "Document Verification"],
    manager: "Mr. Ahmad Hassan",
    established: "2018",
    specializations: ["Canadian Universities", "European Visa Services", "Business Programs", "Technology Courses", "Medical Studies"],
    description: "Located in the vibrant Johar Town area, our Lahore office provides comprehensive educational consultancy services with a focus on personalized student guidance and career development.",
    testimonials: [
      {
        name: "Fatima Sheikh",
        university: "University of Toronto",
        message: "The Johar Town team helped me secure admission to my dream university in Canada. Their guidance was exceptional throughout the process."
      },
      {
        name: "Usman Ali",
        university: "TU Delft",
        message: "Professional and efficient service. The team guided me perfectly for my European university application and visa process."
      },
      {
        name: "Maryam Khan",
        university: "McGill University",
        message: "Outstanding support from consultation to visa approval. The Johar Town office made my Canadian study dreams come true."
      }
    ],
    facilities: ["Student Consultation Rooms", "Document Processing Center", "Test Preparation Hall", "Comfortable Waiting Area", "Refreshment Corner", "Free Wi-Fi", "Parking Space"],
    nearbyLandmarks: ["Emporium Mall", "Johar Town Market", "University of Management & Technology", "Packages Mall", "McDonald's Johar Town", "Cinepax Cinema"]
  };
