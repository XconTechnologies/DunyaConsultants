...
export default function JhelumOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Jhelum Office",
      "Expert study abroad consultants in Jhelum helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
