...
export default function LahoreDHACity() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Lahore DHA City Office",
      "Expert study abroad consultants in Lahore DHA City helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
