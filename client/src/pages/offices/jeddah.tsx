...
export default function JeddahOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Jeddah Office",
      "Expert study abroad consultants in Jeddah helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
