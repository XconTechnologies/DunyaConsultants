...
export default function EdinburghOffice() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Edinburgh Office",
      "Expert study abroad consultants in Edinburgh helping students with university selection, visa guidance, and IELTS preparation for USA, UK, Canada, Australia, and more."
    );
  }, []);
