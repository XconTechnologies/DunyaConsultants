      ...
      <div className="max-w-[1440px] mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <article className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="mb-8">
                ...
                <div className="bg-blue-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold mb-4 text-blue-800">Canada Work Opportunities Overview</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="text-center">
                      <h4 className="text-2xl font-bold text-blue-700 mb-2">20 hrs</h4>
                      <p className="text-blue-600">Per Week (Studies)</p>
                    </div>
                    <div className="text-center">
                      <h4 className="text-2xl font-bold text-blue-700 mb-2">Full-Time</h4>
                      <p className="text-blue-600">During Breaks</p>
                    </div>
                    <div className="text-center">
                      <h4 className="text-2xl font-bold text-blue-700 mb-2">3 Years</h4>
                      <p className="text-blue-600">Post-Study Work</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">Eligibility Requirements for Canada Jobs for Pakistani Students</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              {/* Part-Time Jobs */}
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">Part-Time Canadian Jobs for Pakistani Students</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
              ...
              {/* How to Apply */}
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">How to Apply for Jobs in Canada from Pakistan?</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="space-y-4">
                  <div className="bg-white border-l-4 border-blue-500 p-6 shadow-sm">
                    <div className="flex items-start">
                      <div className="bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold text-lg mr-4 flex-shrink-0">1</div>
                      <div>
                        <h4 className="text-lg font-semibold mb-2 text-blue-800">Identify Your Interests</h4>
                  ...
                  <div className="bg-white border-l-4 border-blue-500 p-6 shadow-sm">
                    <div className="flex items-start">
                      <div className="bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold text-lg mr-4 flex-shrink-0">3</div>
                      <div>
                        <h4 className="text-lg font-semibold mb-2 text-blue-800">Research Employers</h4>
                  ...
                  <div className="bg-white border-l-4 border-blue-500 p-6 shadow-sm">
                    <div className="flex items-start">
                      <div className="bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold text-lg mr-4 flex-shrink-0">4</div>
                      <div>
                        <h4 className="text-lg font-semibold mb-2 text-blue-800">Apply for Jobs</h4>
              ...
              <div className="mb-8">
                <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
                  <h3 className="text-xl font-bold mb-4 text-blue-800">Expected Salary Ranges</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-blue-700 mb-3">Part-Time Jobs (Per Hour)</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-700 mb-3">Full-Time Positions (Annual)</h4>
                      <ul className="space-y-2 text-sm text-gray-700">
          ...
          <div className="w-80">
            ...
            {/* Quick Facts */}
            <div className="bg-blue-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-bold mb-4 text-blue-800">Canada Work Quick Facts</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold text-blue-700">Full-time</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Post-Study Work</span>
                  <span className="text-sm font-bold text-blue-700">Up to 3 years</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Minimum Wage</span>
                  <span className="text-sm font-bold text-blue-700">CAD $15-17</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            {/* Work Types */}
            <div className="bg-blue-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-bold mb-4 text-blue-800">Work Opportunities</h3>
              <ul className="space-y-2 text-sm text-gray-700">
