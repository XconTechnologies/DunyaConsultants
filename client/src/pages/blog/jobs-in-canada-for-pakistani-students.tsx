      ...
      <div className="max-w-[1440px] mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <article className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="mb-8">
                ...
                <div className="bg-blue-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold mb-4 text-#1565c0">Canada Work Opportunities Overview</h3>
              ...
              <div className="mb-8">
                <div className="bg-blue-50 p-6 rounded-lg border-l-4 #4285F4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-#1a73e8 mb-3">Part-Time Jobs (Per Hour)</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-#1a73e8 mb-3">Full-Time Positions (Annual)</h4>
                      <ul className="space-y-2 text-sm text-gray-700">
          ...
          <div className="w-80">
            ...
            {/* Quick Facts */}
            <div className="bg-blue-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-bold mb-4 text-#1565c0">Canada Work Quick Facts</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold text-#1a73e8">Full-time</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Post-Study Work</span>
                  <span className="text-sm font-bold text-#1a73e8">Up to 3 years</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Minimum Wage</span>
                  <span className="text-sm font-bold text-#1a73e8">CAD $15-17</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">SIN Required</span>
                  <span className="text-sm font-bold text-#1a73e8">Yes</span>
                </div>
              </div>
            </div>
            ...
            {/* Job Categories */}
            <div className="bg-blue-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-bold mb-4 text-#1565c0">Popular Job Categories</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• Technology & IT</li>
            ...
            {/* Work Types */}
            <div className="bg-blue-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-bold mb-4 text-#1565c0">Work Opportunities</h3>
              <ul className="space-y-2 text-sm text-gray-700">
