            ...
            <article className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li><a href="#why-study-turkey" className="hover:text-blue-600">Why Choose to Study in Turkey?</a></li>
                  <li><a href="#education-system" className="hover:text-blue-600">Turkish Education System</a></li>
                  ...
                  <li><a href="#accommodation" className="hover:text-blue-600">Student Accommodation</a></li>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-8">
                <h3 className="text-xl font-semibold text-blue-800 mb-4">Study in Turkey at a Glance</h3>
              ...
              <section id="why-study-turkey" className="mb-10">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">Why Choose to Study in Turkey?</h2>
              ...
              <section id="tuition-costs" className="mb-10">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">Tuition Fees and Living Costs</h2>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-blue-50 p-6 rounded-lg">
                    <h3 className="text-xl font-semibold mb-4 text-blue-800">Bachelor Programs</h3>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-blue-600 mb-2">$3,000 - $6,000</div>
                      <p className="text-gray-700 text-sm">with initial deposit of $1,000</p>
                    </div>
                  </div>

                  <div className="bg-blue-50 p-6 rounded-lg">
                    <h3 className="text-xl font-semibold mb-4 text-blue-800">Master's Programs</h3>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-blue-600 mb-2">$4,000 - $6,000</div>
              ...
              <section id="accommodation" className="mb-10">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">Student Accommodation Options</h2>
              ...
              <section id="visa-requirements" className="mb-10">
                ...
                <div className="space-y-4">
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-blue-800 mb-3">Passport Validity</h3>
                    <p className="text-gray-700">Your passport must be valid for at least 90 days.</p>
                  </div>

                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-blue-800 mb-3">Study Visa Form</h3>
                    <p className="text-gray-700">A completed and signed Turkish student visa application form.</p>
                  </div>

                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-blue-800 mb-3">Required Documentation</h3>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
                <h3 className="text-2xl font-bold text-blue-800 mb-4">Ready to Experience Where East Meets West?</h3>
            ...
            <div className="sticky top-8 space-y-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <div className="space-y-3">
                  <a href="/blog/study-in-turkey-2024" className="block text-blue-600 hover:text-blue-800 text-sm">Study in Turkey 2024</a>
                  <a href="/blog/study-in-belgium-guide" className="block text-blue-600 hover:text-blue-800 text-sm">Study in Belgium Guide</a>
                  <a href="/blog/study-in-finland-guide" className="block text-blue-600 hover:text-blue-800 text-sm">Study in Finland Guide</a>
