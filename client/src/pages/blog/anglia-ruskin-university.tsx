              ...
              <section className="mb-8">
                <div className="bg-blue-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                    <Award className="w-6 h-6 #1D50C9 mr-2" />
                    ARU Key Achievements
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center">
                      <Star className="w-5 h-5 #1D50C9 mr-2" />
                    ...
                    <div className="flex items-center">
                      <Calendar className="w-5 h-5 #1D50C9 mr-2" />
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={index} className="flex items-start p-4 bg-gray-50 rounded-lg">
                      <div className="w-8 h-8 #1D50C9 text-white rounded-full flex items-center justify-center mr-4 text-sm font-bold flex-shrink-0">
                        {reason.number}
                      </div>
              ...
              <section className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-white border border-gray-200 rounded-lg">
                    <GraduationCap className="w-8 h-8 #1D50C9 mx-auto mb-2" />
