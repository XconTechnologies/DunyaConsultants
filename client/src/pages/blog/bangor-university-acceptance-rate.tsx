            ...
            <article className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li><a href="#entry-requirements" className="hover:bg-[#1845B3]">Entry Requirements for International Students</a></li>
                  <li><a href="#english-requirements" className="hover:bg-[#1845B3]">English Language Requirements</a></li>
                  <li><a href="#admission-process" className="hover:bg-[#1845B3]">Step-by-Step Admission Process</a></li>
                  <li><a href="#admission-deadlines" className="hover:bg-[#1845B3]">Admission Deadlines 2024-2025</a></li>
                  <li><a href="#dunya-representative" className="hover:bg-[#1845B3]">Dunya Consultants - Official Representative</a></li>
              ...
              <section id="entry-requirements" className="mb-10">
                <h2 className="text-3xl font-bold mb-6 border-l-4 #1D50C9 pl-4">Entry Requirements for International Students</h2>
              ...
              <section id="english-requirements" className="mb-10">
                <h2 className="text-3xl font-bold mb-6 border-l-4 #1D50C9 pl-4">English Language Requirements for Bangor University Pakistan</h2>
              ...
              <section id="admission-process" className="mb-10">
                <h2 className="text-3xl font-bold mb-6 border-l-4 #1D50C9 pl-4">Step-by-Step Bangor University Admissions Process</h2>
              ...
              <section id="admission-deadlines" className="mb-10">
                <h2 className="text-3xl font-bold mb-6 border-l-4 #1D50C9 pl-4">Bangor University Admissions Deadlines 2024-2025</h2>
              ...
              <section id="dunya-representative" className="mb-10">
                <h2 className="text-3xl font-bold mb-6 border-l-4 #1D50C9 pl-4">Dunya Consultants – Official Bangor University Representative in Pakistan</h2>
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium #1845B3">70-80%</span>
                  </div>
                  <div className="flex justify-between">
