  ...
  const internshipTypes = [
    {
      ...
      icon: <GraduationCap className="w-8 h-8 #3367D6" />,
    ...
    },
    {
      ...
      icon: <Clock className="w-8 h-8 #3367D6" />,
    ...
    },
    {
      ...
      icon: <Briefcase className="w-8 h-8 #3367D6" />,
    ...
    },
    {
      ...
      icon: <Users className="w-8 h-8 #3367D6" />,
    ...
    },
    {
      ...
      icon: <MapPin className="w-8 h-8 #3367D6" />,
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-[1440px] mx-auto px-4 py-4">
          <Link href="/blog" className="inline-flex items-center #3367D6 hover:text-#1565c0 mb-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <button className="p-2 text-gray-600 hover:#3367D6 rounded-full hover:bg-blue-50">
      ...
      <div className="relative w-full h-96 bg-cover bg-center bg-no-repeat" style={{
        ...
        {/* Color Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#4285F4]/80 to-[#3367D6]/80"></div>
            ...
            <article className="bg-white rounded-lg shadow-sm">
              ...
              <div className="p-8">
                ...
                <div>
                  ...
                  <div className="bg-blue-50 border-l-4 #4285F4 p-6 my-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
                    <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-lg p-6">
                      <div className="flex items-center mb-4">
                        <Briefcase className="w-8 h-8 #3367D6 mr-3" />
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6">
                      <div className="flex items-center mb-4">
                        <Users className="w-8 h-8 #3367D6 mr-3" />
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 border-l-4 #4285F4 pl-4">
                      ...
                      <div key={index} className="bg-white border rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-start">
                          <div className="bg-blue-100 rounded-full p-3 mr-4 flex-shrink-0">
                            <span className="#3367D6 font-bold text-sm">{index + 1}</span>
                          </div>
                          <div>
                  ...
                  <div className="bg-white rounded-lg p-6 my-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        <ChevronRight className="w-5 h-5 #3367D6 mr-2 mt-0.5" />
                        <div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <nav className="space-y-2">
                  <a href="#types" className="block text-sm #3367D6 hover:text-#1565c0">Types of Internships</a>
                  <a href="#programs" className="block text-sm #3367D6 hover:text-#1565c0">Best Programs</a>
                  <a href="#benefits" className="block text-sm #3367D6 hover:text-#1565c0">Benefits</a>
                  <a href="#application" className="block text-sm #3367D6 hover:text-#1565c0">Application Tips</a>
                  <a href="#conclusion" className="block text-sm #3367D6 hover:text-#1565c0">Conclusion</a>
                  <a href="#faq" className="block text-sm #3367D6 hover:text-#1565c0">FAQ</a>
                </nav>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  <Link href="/blog/top-study-abroad-countries" className="block hover:#3367D6">
                  ...
                  <Link href="/blog/oxford-test-accepted-universities-uk" className="block hover:#3367D6">
                  ...
                  <Link href="/blog/ielts-listening-skills" className="block hover:#3367D6">
