      ...
      <div className="bg-[#124FD3] text-white py-20">
        <div className="max-w-[1440px] mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-6">
              <span className="text-white px-4 py-2 rounded-full text-sm font-medium" style={{ backgroundColor: '#1D2D4E' }}>
                Visa Guides
              </span>
            </div>
            ...
            <article className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li><a href="#common-mistakes" className="hover:underline" style={{ color: '#1D2D4E' }}>Common Mistakes to Avoid</a></li>
                  <li><a href="#insufficient-funds" className="hover:underline" style={{ color: '#1D2D4E' }}>1. Insufficient Proof of Funds</a></li>
                  <li><a href="#documentation-errors" className="hover:underline" style={{ color: '#1D2D4E' }}>2. Documentation Errors</a></li>
                  <li><a href="#english-proficiency" className="hover:underline" style={{ color: '#1D2D4E' }}>3. Incorrect English Proficiency Proof</a></li>
                  <li><a href="#cas-details" className="hover:underline" style={{ color: '#1D2D4E' }}>4. Not Checking CAS Details</a></li>
                  <li><a href="#past-records" className="hover:underline" style={{ color: '#1D2D4E' }}>5. Not Disclosing Past Records</a></li>
                  <li><a href="#success-tips" className="hover:underline" style={{ color: '#1D2D4E' }}>Additional Success Tips</a></li>
                  <li><a href="#faqs" className="hover:underline" style={{ color: '#1D2D4E' }}>Frequently Asked Questions</a></li>
                </ul>
              </div>

              {/* Success Rate Highlight */}
              <div className="p-6 mb-8" style={{ backgroundColor: '#e8f0ff', borderLeft: '4px solid #1D2D4E' }}>
                <h3 className="text-xl font-semibold mb-4" style={{ color: '#1D2D4E' }}>UK Visa Success Rate</h3>
              ...
              <section id="common-mistakes" className="mb-10">
                <h2 className="text-3xl font-bold mb-6 pl-4" style={{ borderLeft: '4px solid #1D2D4E' }}>Common Mistakes to Avoid while Applying for a UK Student Visa</h2>
              ...
              <section id="insufficient-funds" className="mb-10">
                <h3 className="text-2xl font-bold mb-6 pl-4" style={{ borderLeft: '4px solid #1D2D4E' }}>1. Insufficient Proof of Funds</h3>
                ...
                <div className="rounded-lg p-6 mb-6" style={{ backgroundColor: '#e8f0ff', border: '1px solid #b3d1ff' }}>
                  <h4 className="text-lg font-semibold mb-4 flex items-center" style={{ color: '#1D2D4E' }}>
                    <CreditCard className="w-5 h-5 mr-2" />
                    Financial Requirements Checklist
                  </h4>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <CheckCircle className="w-4 h-4 mr-2 mt-1 flex-shrink-0" style={{ color: '#1D2D4E' }} />
                ...
                <div className="p-6 rounded-lg" style={{ backgroundColor: '#e8f0ff' }}>
                  <h4 className="text-lg font-semibold mb-3" style={{ color: '#1D2D4E' }}>Required Amounts (2025):</h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
              ...
              <section id="documentation-errors" className="mb-10">
                <h3 className="text-2xl font-bold mb-6 pl-4" style={{ borderLeft: '4px solid #1D2D4E' }}>2. Avoid Documentation Errors</h3>
                ...
                <div className="space-y-4">
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h4 className="text-lg font-semibold mb-3 flex items-center" style={{ color: '#1D2D4E' }}>
                  ...
                  <div className="rounded-lg p-6" style={{ backgroundColor: '#e8f0ff', border: '1px solid #b3d1ff' }}>
                    <h4 className="text-lg font-semibold mb-3" style={{ color: '#1D2D4E' }}>Common Documentation Mistakes:</h4>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
              ...
              <section id="english-proficiency" className="mb-10">
                <h3 className="text-2xl font-bold mb-6 pl-4" style={{ borderLeft: '4px solid #1D2D4E' }}>3. Incorrect English Proficiency Proof</h3>
                ...
                <div className="p-6 rounded-lg" style={{ backgroundColor: '#e8f0ff' }}>
                  <h4 className="text-lg font-semibold mb-4" style={{ color: '#1D2D4E' }}>Accepted English Tests & Minimum Scores:</h4>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
