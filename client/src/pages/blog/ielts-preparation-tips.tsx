        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <article className="bg-white rounded-lg shadow-sm">
              {/* Hero Image */}
              <div className="aspect-video bg-gradient-to-r from-emerald-600 to-teal-600 rounded-t-lg flex items-center justify-center">
                <div className="text-center text-white">
                  <h1 className="text-3xl font-bold mb-2">Top 10 IELTS Preparation Tips</h1>
                  <p className="text-xl opacity-90">Master IELTS with Expert Tips for High Band Score</p>
                </div>
              </div>
