...
export default function NewYearResolutionsForStudents2025() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <div className="relative w-full h-96 bg-gradient-to-r from-[#1D50C9] to-#1565c0">
        <div 
        ...
        <div className="relative z-10 flex items-center justify-center h-full text-center text-white px-4">
          <div>
            <h1 className="font-bold leading-tight mb-8 text-white italic" style={{ fontSize: '64px' }}>New Year Resolutions for Students 2025</h1>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      <div className="w-3 h-3 #1845B3 rounded-full"></div>
