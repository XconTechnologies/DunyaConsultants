              ...
              <div className="bg-blue-50 rounded-lg p-6 mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center">
                    <Clock className="w-5 h-5 #3367D6 mr-2" />
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                            <span className="#3367D6 font-bold text-sm">{uni.rank}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        <li className="flex items-start">
                          <CheckCircle className="w-5 h-5 #4285F4 mr-2 mt-0.5" />
                ...
                <div className="space-y-4">
                  <div className="bg-white border rounded-lg p-6">
                    <div className="flex items-center mb-3">
                      <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center #3367D6 font-semibold mr-3">1</div>
                  ...
                  <div className="bg-white border rounded-lg p-6">
                    <div className="flex items-center mb-3">
                      <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center #3367D6 font-semibold mr-3">2</div>
                  ...
                  <div className="bg-white border rounded-lg p-6">
                    <div className="flex items-center mb-3">
                      <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center #3367D6 font-semibold mr-3">3</div>
                  ...
                  <div className="bg-white border rounded-lg p-6">
                    <div className="flex items-center mb-3">
                      <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center #3367D6 font-semibold mr-3">4</div>
                  ...
                  <div className="bg-white border rounded-lg p-6">
                    <div className="flex items-center mb-3">
                      <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center #3367D6 font-semibold mr-3">5</div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-pink-50 rounded-lg p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center">
                          <CheckCircle className="w-4 h-4 #4285F4 mr-2" />
              ...
              <section className="mb-8">
                ...
                <div className="bg-blue-50 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    <Heart className="w-6 h-6 #3367D6 mr-3" />
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <button className="w-full #3367D6 text-white py-2 px-4 rounded-lg hover:bg-#1a73e8 transition-colors mt-4">
                  Get Consultation
                </button>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-2">
                  <a href="#universities" className="block text-sm text-gray-600 hover:#3367D6">Top Universities</a>
                  <a href="#eligibility" className="block text-sm text-gray-600 hover:#3367D6">Eligibility</a>
                  <a href="#documents" className="block text-sm text-gray-600 hover:#3367D6">Documents</a>
                  <a href="#application" className="block text-sm text-gray-600 hover:#3367D6">Application Process</a>
                  <a href="#cost" className="block text-sm text-gray-600 hover:#3367D6">Cost Information</a>
                  <a href="#career" className="block text-sm text-gray-600 hover:#3367D6">Career Prospects</a>
                </div>
              </div>
