      ...
      <div className="max-w-[1440px] mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-r from-indigo-600 via-purple-700 to-pink-800 flex items-center justify-center text-white">
          ...
          <div className="relative z-10 text-center px-8">
            <h1 className="text-5xl font-bold mb-4">IELTS Exam Fee in Pakistan</h1>
            <p className="text-2xl font-light">Complete guide to IELTS test costs, format, and registration</p>
          </div>
        </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <Card className="bg-gradient-to-br from-blue-50 to-indigo-100 border-blue-200">
                    <CardContent className="p-6">
                      <h3 className="text-xl font-bold text-blue-800 mb-3">IELTS General Training</h3>
