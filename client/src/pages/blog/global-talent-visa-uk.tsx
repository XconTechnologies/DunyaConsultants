            ...
            <article className="bg-white rounded-lg shadow-sm border p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li><a href="#eligibility" className="hover:text-blue-600">Eligibility Criteria for Global UK Talent Visa</a></li>
                  <li><a href="#documents" className="hover:text-blue-600">Documents Required for Global Talent UK Visa</a></li>
                  <li><a href="#application-process" className="hover:text-blue-600">How to Apply for a Global Talent Visa for UK?</a></li>
                  <li><a href="#costs" className="hover:text-blue-600">Cost to apply for Global Talent UK Visa</a></li>
                  <li><a href="#timeline" className="hover:text-blue-600">When will you receive your Global Talent Visa UK?</a></li>
              ...
              <div className="mb-8" id="eligibility">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">Eligibility Criteria for Global UK Talent Visa</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
                  To be eligible for a UK Global Talent Visa, you need to meet global talent visa requirements as given below:
                </p>
                
                <div className="bg-blue-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold mb-3 text-blue-800">Key Requirements</h3>
              ...
              <div className="mb-8" id="documents">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">Documents Required for Global Talent UK Visa</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <div className="mb-8" id="application-process">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">How to Apply for a Global Talent Visa for UK?</h2>
              ...
              <div className="mb-8" id="timeline">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">When will you receive your Global Talent Visa UK?</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <h4 className="font-semibold text-blue-800 mb-2">Priority Service</h4>
