            ...
            <article className="bg-white rounded-lg shadow-sm border p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li><a href="#eligibility" className="hover:#3367D6">Eligibility Criteria for Global UK Talent Visa</a></li>
                  <li><a href="#documents" className="hover:#3367D6">Documents Required for Global Talent UK Visa</a></li>
                  <li><a href="#application-process" className="hover:#3367D6">How to Apply for a Global Talent Visa for UK?</a></li>
                  <li><a href="#costs" className="hover:#3367D6">Cost to apply for Global Talent UK Visa</a></li>
                  <li><a href="#timeline" className="hover:#3367D6">When will you receive your Global Talent Visa UK?</a></li>
              ...
              <div className="mb-8" id="eligibility">
                <h2 className="text-3xl font-bold mb-6 border-l-4 #4285F4 pl-4">Eligibility Criteria for Global UK Talent Visa</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <div className="mb-8" id="documents">
                <h2 className="text-3xl font-bold mb-6 border-l-4 #4285F4 pl-4">Documents Required for Global Talent UK Visa</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <div className="mb-8" id="application-process">
                <h2 className="text-3xl font-bold mb-6 border-l-4 #4285F4 pl-4">How to Apply for a Global Talent Visa for UK?</h2>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="#4285F4 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-4 mt-1">1</div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="#4285F4 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-4 mt-1">2</div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="#4285F4 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-4 mt-1">3</div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="#4285F4 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-4 mt-1">4</div>
                    <div>
              ...
              <div className="mb-8" id="costs">
                <h2 className="text-3xl font-bold mb-6 border-l-4 #4285F4 pl-4">Cost to apply for Global Talent UK Visa</h2>
              ...
              <div className="mb-8" id="timeline">
                <h2 className="text-3xl font-bold mb-6 border-l-4 #4285F4 pl-4">When will you receive your Global Talent Visa UK?</h2>
