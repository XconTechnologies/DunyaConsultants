  ...
  return (
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[1440px] mx-auto px-4 py-8">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-[#1D50C9] via-#1a73e8 to-cyan-800 flex items-center justify-center text-white">
          <div 
          ...
          <div className="relative z-10 text-center px-8">
            <h1 className="text-3xl lg:text-4xl font-bold mb-4 text-white italic">MOI Accepted Universities in UK</h1>
            <p className="text-white text-sm lg:text-base max-w-3xl mx-auto leading-relaxed">Complete guide to universities accepting Medium of Instruction</p>
          </div>
        </div>
              ...
              <div className="mb-8">
                ...
                <div className="space-y-6">
                  {moiSteps.map((step, index) => (
                    ...
                    >
                      <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#1D50C9] to-teal-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
                        {step.step}
                      </div>
                      <div className="lg:col-span-3">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                      <div className="w-8 h-8 #1845B3 rounded-full flex items-center justify-center text-white text-sm font-bold">1</div>
                      <div>
                    ...
                    <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                      <div className="w-8 h-8 #1845B3 rounded-full flex items-center justify-center text-white text-sm font-bold">2</div>
                      <div>
                    ...
                    <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                      <div className="w-8 h-8 #1845B3 rounded-full flex items-center justify-center text-white text-sm font-bold">3</div>
                      <div>
              ...
              <Card className="bg-white border border-gray-200">
                <CardContent className="p-6">
                  ...
                  <form className="space-y-4">
                    ...
                    <Button className="w-full bg-gradient-to-r from-[#1D50C9] to-teal-600 hover:from-emerald-700 hover:to-teal-700">
                      Get MOI Assessment
                    </Button>
                  </form>
                </CardContent>
