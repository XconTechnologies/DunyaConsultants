            ...
            <article className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li><a href="#why-study-canada" className="hover:text-blue-600">Why Choose to Study in Canada?</a></li>
                  <li><a href="#education-system" className="hover:text-blue-600">Canadian Education System</a></li>
                  ...
                  <li><a href="#tuition-costs" className="hover:text-blue-600">Tuition Fees and GIC</a></li>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-8">
                <h3 className="text-xl font-semibold text-blue-800 mb-4">Study in Canada at a Glance</h3>
              ...
              <section id="why-study-canada" className="mb-10">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">Why Choose to Study in Canada?</h2>
              ...
              <section id="visa-requirements" className="mb-10">
                ...
                <div className="space-y-4">
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-blue-800 mb-3">Official Transcripts</h3>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-blue-800 mb-3">GIC (Guaranteed Investment Certificate)</h3>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-blue-800 mb-3">Photos and Documentation</h3>
                    <ul className="text-gray-700 space-y-1">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-blue-800 mb-3">Medical & Biometric Information</h3>
                    <ul className="text-gray-700 space-y-1">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-blue-50 p-6 rounded-lg">
                    ...
                    <div className="text-center">
                      <div className="text-3xl font-bold text-blue-600 mb-2">CAD $36,100</div>
                  ...
                  <div className="bg-blue-50 p-6 rounded-lg">
                    ...
                    <div className="text-center">
                      <div className="text-3xl font-bold text-blue-600 mb-2">CAD $21,100</div>
                      <p className="text-gray-700 text-sm">per year (average)</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
                <h3 className="text-2xl font-bold text-blue-800 mb-4">Ready to Start Your Canada Study Journey?</h3>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <div className="space-y-3">
                  <a href="/blog/study-engineering-in-canada-2025" className="block text-blue-600 hover:text-blue-800 text-sm">Study Engineering in Canada</a>
                  ...
                  <a href="/blog/engineering-and-law-programs-canada" className="block text-blue-600 hover:text-blue-800 text-sm">Engineering Programs Canada</a>
                </div>
              </div>
