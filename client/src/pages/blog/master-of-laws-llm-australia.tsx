        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <article className="bg-white rounded-lg shadow-sm">
              {/* Hero Image */}
              <div className="aspect-video bg-gradient-to-r from-green-600 to-blue-600 rounded-t-lg flex items-center justify-center">
                <div className="text-center text-white">
                  <h1 className="text-3xl font-bold mb-2">Master of Laws (LLM) in Australia</h1>
                  <p className="text-xl opacity-90">Your Complete Guide to Studying Law in Australia</p>
                </div>
              </div>
