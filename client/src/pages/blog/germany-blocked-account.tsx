                ...
                <div className="bg-blue-50 p-6 rounded-lg mb-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center border-b pb-2">
                      ...
                      <span className="text-xl font-bold text-#1a73e8">€11,904</span>
                    </div>
                    <div className="flex justify-between items-center border-b pb-2">
                      <span className="text-gray-700">Monthly Withdrawal Limit</span>
                      <span className="text-xl font-bold text-#1a73e8">€992</span>
                    </div>
                    <div className="flex justify-between items-center border-b pb-2">
                      <span className="text-gray-700">Coverage Period</span>
                      <span className="text-xl font-bold text-#1a73e8">12 Months</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Based on BAföG Rate</span>
                      <span className="text-xl font-bold text-#1a73e8">Yes</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="bg-blue-50 p-6 rounded-lg mb-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div className="text-center p-3 bg-white rounded border">
                      <h4 className="font-semibold text-#1a73e8">Studley</h4>
                    </div>
                    <div className="text-center p-3 bg-white rounded border">
                      <h4 className="font-semibold text-#1a73e8">Expatrio</h4>
                    </div>
                    <div className="text-center p-3 bg-white rounded border">
                      <h4 className="font-semibold text-#1a73e8">Coracle</h4>
                    </div>
                    <div className="text-center p-3 bg-white rounded border">
                      <h4 className="font-semibold text-#1a73e8">ICICI Bank</h4>
                    </div>
                    <div className="text-center p-3 bg-white rounded border">
                      <h4 className="font-semibold text-#1a73e8">Drop Money</h4>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 p-6 rounded-lg mb-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded border">
                      <div className="flex justify-between items-center">
                        <h4 className="font-semibold text-#1a73e8">Expatrio</h4>
                        <span className="text-xl font-bold text-#1a73e8">€109</span>
                      </div>
                    ...
                    <div className="bg-white p-4 rounded border">
                      <div className="flex justify-between items-center">
                        <h4 className="font-semibold text-#1a73e8">Coracle</h4>
                        <span className="text-xl font-bold text-#1a73e8">€99</span>
                      </div>
            ...
            <div className="bg-blue-50 p-6 rounded-lg mb-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold text-#1a73e8">€11,904</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Monthly Limit</span>
                  <span className="text-sm font-bold text-#1a73e8">€992</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Coverage Period</span>
                  <span className="text-sm font-bold text-#1a73e8">12 Months</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Setup Fees</span>
                  <span className="text-sm font-bold text-#1a73e8">€99-€109</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Mandatory for</span>
                  <span className="text-sm font-bold text-#1a73e8">Non-EU Students</span>
                </div>
              </div>
            </div>
