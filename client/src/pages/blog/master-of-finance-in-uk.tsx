  ...
  return (
    <>
      ...
      <div className="w-[1440px] mx-auto">
        {/* Hero Section */}
        <div className="relative h-[500px] bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 flex items-center justify-center text-white">
          <div 
        ...
        <div className="flex gap-8 p-8">
          ...
          <div className="flex-1">
            <article className="prose prose-lg max-w-none">
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-emerald-500 pl-4">What is MSc finance in UK?</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="bg-emerald-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold mb-4 text-emerald-800">Program Overview</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="text-center">
                      <h4 className="text-2xl font-bold text-emerald-700 mb-2">174</h4>
                      <p className="text-emerald-600">Universities Offering</p>
                    </div>
                    <div className="text-center">
                      <h4 className="text-2xl font-bold text-emerald-700 mb-2">High</h4>
                      <p className="text-emerald-600">Earning Potential</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-teal-500 pl-4">Universities in UK for Masters in Finance</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="bg-teal-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold mb-4 text-teal-800">Top Universities for Masters in Finance</h3>
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-cyan-500 pl-4">Eligibility Criteria for MSc Finance in UK Universities</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="bg-cyan-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold mb-4 text-cyan-800">Key Requirements</h3>
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-orange-500 pl-4">Documents Required for UK Best Colleges for Masters in Finance</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
                  All documents that you will need to gather before applying for MSc in Finance UK are mentioned below:
                </p>

                <div className="bg-orange-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold mb-4 text-orange-800">Required Documents</h3>
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start">
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-purple-500 pl-4">Admission Process of Master in Finance UK</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
                  Here is a simple step-by-step guide for you to apply for a master of Finance at a UK university:
                </p>

                <div className="bg-purple-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold mb-4 text-purple-800">Application Steps</h3>
                  <ol className="space-y-4 text-gray-700">
                    ...
                    <li className="flex items-start">
                      <span className="bg-purple-200 text-purple-800 font-bold rounded-full w-8 h-8 flex items-center justify-center mr-3 mt-1">6</span>
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-red-500 pl-4">Average Fee to Study MSc Finance in UK</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-6 border-l-4 border-green-500 pl-4">Scholarships Available for UK Masters in Finance</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="bg-green-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold mb-4 text-green-800">Available Scholarships</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
          ...
          <div className="w-80">
            ...
            {/* Quick Facts */}
            <div className="bg-emerald-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-bold mb-4 text-emerald-800">Quick Facts</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-bold text-emerald-700">£32,000</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Universities Available</span>
                  <span className="text-sm font-bold text-emerald-700">174</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-700">Starting Salary</span>
                  <span className="text-sm font-bold text-emerald-700">£35,000-£55,000</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            {/* Top Universities */}
            <div className="bg-teal-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-bold mb-4 text-teal-800">Top 5 Universities</h3>
            ...
            <div className="bg-cyan-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-bold mb-4 text-cyan-800">Scholarship Opportunities</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• Clarendon Fund</li>
                <li>• WMG Excellence Scholarships</li>
                <li>• Gates Cambridge Scholarship</li>
