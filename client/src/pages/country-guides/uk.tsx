...
export default function UKGuide() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50" ref={ref}>
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-blue-900 via-red-700 to-blue-800 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <div className="w-full h-full bg-gradient-to-r from-blue-600/30 to-red-600/30"></div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-blue-900 to-red-700 text-white">
