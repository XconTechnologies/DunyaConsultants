...
export default function USAGuide() {
  ...
  useEffect(() => {
    setStaticPageMeta(
      "Study in USA",
      "Complete guide to studying in USA. Learn about top universities, admission requirements, costs, scholarships, visa process, and career opportunities for international students."
    );
  }, []);
