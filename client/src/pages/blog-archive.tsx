...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "22 min",
    views: 32000,
    tags: ["Pakistan", "Degree Selection", "Career Guidance", "Engineering", "IT", "Business", "Medicine", "Education"],
  ...
  },
  {
    ...
    readTime: "18 min",
    views: 28500,
    tags: ["Canada", "Student Visa", "Pakistan", "Study Permit", "Application Process", "Visa Requirements"],
  ...
  },
  {
    ...
    readTime: "20 min", 
    views: 25200,
    tags: ["UK", "LLM", "Law Degree", "Pakistani Students", "Universities", "Scholarships", "Legal Career"],
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    featured: true,
    trending: true,
  ...
  },
  {
    ...
    readTime: "18 min",
    views: 24300,
    tags: ["Germany", "Blocked Account", "Student Visa", "Financial Requirements", "Study Abroad"],
  ...
  },
  {
    ...
    readTime: "16 min",
    views: 32400,
    tags: ["UK Visa", "Student Visa", "Pakistan", "Success Rate", "Visa Statistics"],
