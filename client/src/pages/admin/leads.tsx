...
import { Search, Mail, Phone, Globe, Calendar, Filter, Download, Trash2, ChevronLeft, ChevronRight } from "lucide-react";
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-gray-600 bg-white px-3 py-1.5 rounded-md border border-gray-200 shadow-sm">
                              Showing <span className="font-semibold text-[#1D50C9]">{startIndex + 1}</span> to <span className="font-semibold text-[#1D50C9]">{Math.min(endIndex, filteredLeads.length)}</span> of <span className="font-semibold text-[#1D50C9]">{filteredLeads.length}</span>
                            </span>
                          </div>
