            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  />
                  {errors.title && (
                    <p className="#4285F4 text-sm mt-1">{errors.title.message}</p>
                  )}
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  />
                  {errors.slug && (
                    <p className="#4285F4 text-sm mt-1">{errors.slug.message}</p>
                  )}
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  />
                  {errors.excerpt && (
                    <p className="#4285F4 text-sm mt-1">{errors.excerpt.message}</p>
                  )}
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  />
                  {errors.content && (
                    <p className="#4285F4 text-sm mt-1">{errors.content.message}</p>
                  )}
