      ...
      <div className="max-w-[1600px] mx-auto px-6 py-8">
        <form id="blog-form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            ...
            className={`fixed ${isSidebarOpen ? 'right-[calc(25%-1.25rem-100px)]' : 'right-4'} top-24 z-20 w-10 h-10 rounded-full bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700 flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 group`}
